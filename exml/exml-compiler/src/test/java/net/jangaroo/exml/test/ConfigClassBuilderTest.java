...
public class ConfigClassBuilderTest {
  ...
  public void testBuildConfigClass() throws Exception {
    ...
    Assert.assertEquals("This is a TestComponent with panel as baseclass. <p>This class serves as a typed config object for the constructor of the class <code>testPackage.TestComponent</code>. Using this config class also takes care of registering the target class under the xtype \"testNamespace.config.testComponent\" with Ext JS.</p> @see testPackage.TestComponent", configClass.getDescription());
