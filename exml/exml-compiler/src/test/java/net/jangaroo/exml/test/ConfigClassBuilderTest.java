...
public class ConfigClassBuilderTest {
  ...
  public void testBuildConfigClass() throws Exception {
    ...
    Assert.assertEquals("This is a TestComponent with panel as baseclass. <p> <b>Do not instantiate this class!</b> Instead, instantiate the associated component class testPackage.TestComponent directly. This class is only provided to document the config attributes to use when building instances of the component class. </p> @see testPackage.TestComponent", configClass.getDescription());
