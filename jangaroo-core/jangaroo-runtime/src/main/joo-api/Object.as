...
public dynamic class Object {
   ...
   * <ul>
   * <li>Fixed instance properties要ariables, constants, or methods defined by the object's class that are not static;</li>
   * <li>Inherited fixed instance properties要ariables, constants, or methods inherited by the object's class;</li>
   * <li>Dynamic properties用roperties added to an object after it is instantiated (outside of its class definition). To add dynamic properties, the object's defining class must be declared with the <code>dynamic</code> keyword.</li></ul>
