 ...
 * <li>A method is invoked on an incompatible object.  For example, a TypeError exception is thrown if a RegExp class
 * method is "grafted" onto a generic object and then invoked.</li>
 * </ul>
 * @see http://help.adobe.com/en_US/FlashPlatform/reference/actionscript/3/operators.html#is is operator
 * @see http://help.adobe.com/en_US/FlashPlatform/reference/actionscript/3/operators.html#is instanceof operator
