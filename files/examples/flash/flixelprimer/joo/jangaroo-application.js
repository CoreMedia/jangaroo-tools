...
// FROM net.jangaroo:jangaroo-runtime:0.8.3:
...
// FROM net.jangaroo:jangaroo-browser:0.8.5:
joo.loadModule("net.jangaroo","jangaroo-browser");

// FROM net.jangaroo:jooflash:0.8.5:
joo.loadScript("joo/net.jangaroo.jooflash-native.js");
joo.loadModule("net.jangaroo", "jooflash");

// FROM net.jangaroo.flash.examples:flixel:0.8.5-SNAPSHOT:
joo.loadModule("net.jangaroo.flash.examples","flixel");

// FROM net.jangaroo.flash:flixel-primer:0.8.5-SNAPSHOT:
joo.loadModule("net.jangaroo.flash","flixel-primer");
