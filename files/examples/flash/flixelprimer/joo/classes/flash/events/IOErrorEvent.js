...
"public class IOErrorEvent extends flash.events.ErrorEvent",4,function($$private){;return[ 
   ...
   *
   */
  "public function IOErrorEvent",function IOErrorEvent$(type/*:String*/, bubbles/*:Boolean = false*/, cancelable/*:Boolean = false*/, text/*:String = ""*/, id/*:int = 0*/) {if(arguments.length<5){if(arguments.length<4){if(arguments.length<3){if(arguments.length<2){bubbles = false;}cancelable = false;}text = "";}id = 0;}
