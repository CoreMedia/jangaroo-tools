...
"public class Event",1,function($$private){;return[ 
   ...
   *
   */
  "public function Event",function Event$(type/*:String*/, bubbles/*:Boolean = false*/, cancelable/*:Boolean = false*/) {if(arguments.length<3){if(arguments.length<2){bubbles = false;}cancelable = false;}
    this['type'] = type;
