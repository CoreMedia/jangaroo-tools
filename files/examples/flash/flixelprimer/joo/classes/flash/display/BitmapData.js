...
"public class BitmapData implements flash.display.IBitmapDrawable",1,function($$private){var is=joo.is,as=joo.as;return[ 
   ...
   *
   */
  "public function BitmapData",function BitmapData$(width/*:int*/, height/*:int*/, transparent/*:Boolean = true*/, fillColor/*:uint = 0xFFFFFFFF*/) {if(arguments.length<4){if(arguments.length<3){transparent = true;}fillColor = 0xFFFFFFFF;}this.elementChangeListeners$1=this.elementChangeListeners$1();
  ...
  "public function copyPixels",function copyPixels(sourceBitmapData/*:BitmapData*/, sourceRect/*:Rectangle*/, destPoint/*:Point*/,
                             alphaBitmapData/*:BitmapData = null*/, alphaPoint/*:Point = null*/, mergeAlpha/*:Boolean = false*/)/*:void*/ {if(arguments.length<6){if(arguments.length<5){if(arguments.length<4){alphaBitmapData = null;}alphaPoint = null;}mergeAlpha = false;}
   ...
   * </listing>
   */
  "public function getColorBoundsRect",function getColorBoundsRect(mask/*:uint*/, color/*:uint*/, findColor/*:Boolean = true*/)/*:Rectangle*/ {if(arguments.length<3){findColor = true;}
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   * </listing>
   */
  "public function hitTest",function hitTest(firstPoint/*:Point*/, firstAlphaThreshold/*:uint*/, secondObject/*:Object*/, secondBitmapDataPoint/*:Point = null*/, secondAlphaThreshold/*:uint = 1*/)/*:Boolean*/ {if(arguments.length<5){if(arguments.length<4){secondBitmapDataPoint = null;}secondAlphaThreshold = 1;}
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   * </listing>
   */
  "public function noise",function noise(randomSeed/*:int*/, low/*:uint = 0*/, high/*:uint = 255*/, channelOptions/*:uint = 7*/, grayScale/*:Boolean = false*/)/*:void*/ {if(arguments.length<5){if(arguments.length<4){if(arguments.length<3){if(arguments.length<2){low = 0;}high = 255;}channelOptions = 7;}grayScale = false;}
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   * </listing>
   */
  "public function paletteMap",function paletteMap(sourceBitmapData/*:BitmapData*/, sourceRect/*:Rectangle*/, destPoint/*:Point*/, redArray/*:Array = null*/, greenArray/*:Array = null*/, blueArray/*:Array = null*/, alphaArray/*:Array = null*/)/*:void*/ {if(arguments.length<7){if(arguments.length<6){if(arguments.length<5){if(arguments.length<4){redArray = null;}greenArray = null;}blueArray = null;}alphaArray = null;}
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   * </listing>
   */
  "public function perlinNoise",function perlinNoise(baseX/*:Number*/, baseY/*:Number*/, numOctaves/*:uint*/, randomSeed/*:int*/, stitch/*:Boolean*/, fractalNoise/*:Boolean*/, channelOptions/*:uint = 7*/, grayScale/*:Boolean = false*/, offsets/*:Array = null*/)/*:void*/ {if(arguments.length<9){if(arguments.length<8){if(arguments.length<7){channelOptions = 7;}grayScale = false;}offsets = null;}
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   * </listing>
   */
  "public function pixelDissolve",function pixelDissolve(sourceBitmapData/*:BitmapData*/, sourceRect/*:Rectangle*/, destPoint/*:Point*/, randomSeed/*:int = 0*/, numPixels/*:int = 0*/, fillColor/*:uint = 0*/)/*:int*/ {if(arguments.length<6){if(arguments.length<5){if(arguments.length<4){randomSeed = 0;}numPixels = 0;}fillColor = 0;}
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   * </listing>
   */
  "public function threshold",function threshold(sourceBitmapData/*:BitmapData*/, sourceRect/*:Rectangle*/, destPoint/*:Point*/, operation/*:String*/, threshold/*:uint*/, color/*:uint = 0*/, mask/*:uint = 0xFFFFFFFF*/, copySource/*:Boolean = false*/)/*:uint*/ {if(arguments.length<8){if(arguments.length<7){if(arguments.length<6){color = 0;}mask = 0xFFFFFFFF;}copySource = false;}
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   * </listing>
   */
  "public function unlock",function unlock(changeRect/*:Rectangle = null*/)/*:void*/ {if(arguments.length<1){changeRect = null;}
    // TODO: see lock()
  },
