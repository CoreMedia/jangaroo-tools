...
"public dynamic class MovieClip extends flash.display.Sprite",6,function($$private){;return[ 
   ...
   * </listing></div>
   */
  "public function gotoAndPlay",function gotoAndPlay(frame/*:Object*/, scene/*:String = null*/)/*:void*/ {if(arguments.length<2){scene = null;}
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   * </listing></div>
   */
  "public function gotoAndStop",function gotoAndStop(frame/*:Object*/, scene/*:String = null*/)/*:void*/ {if(arguments.length<2){scene = null;}
    throw new Error('not implemented'); // TODO: implement!
  },
