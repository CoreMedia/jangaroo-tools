...
"public class Rectangle",1,function($$private){;return[ 
   ...
   *
   */
  "public function Rectangle",function Rectangle$(x/*:Number = 0*/, y/*:Number = 0*/, width/*:Number = 0*/, height/*:Number = 0*/) {if(arguments.length<4){if(arguments.length<3){if(arguments.length<2){if(arguments.length<1){x = 0;}y = 0;}width = 0;}height = 0;}
    this.x = x;
    this.y = y;
    this.width = width;
    this.height = height;
