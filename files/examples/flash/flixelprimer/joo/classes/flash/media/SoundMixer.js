...
"public final class SoundMixer",1,function($$private){;return[ 
   ...
   * </listing>
   */
  "public static function computeSpectrum",function computeSpectrum(outputArray/*:ByteArray*/, FFTMode/*:Boolean = false*/, stretchFactor/*:int = 0*/)/*:void*/ {if(arguments.length<3){if(arguments.length<2){FFTMode = false;}stretchFactor = 0;}
    throw new Error('not implemented'); // TODO: implement!
  },
