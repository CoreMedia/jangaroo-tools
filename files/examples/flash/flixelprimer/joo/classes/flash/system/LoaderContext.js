...
"public class LoaderContext",1,function($$private){;return[ 
   ...
   *
   */
  "public function LoaderContext",function LoaderContext$(checkPolicyFile/*:Boolean = false*/, applicationDomain/*:ApplicationDomain = null*/, securityDomain/*:SecurityDomain = null*/) {if(arguments.length<3){if(arguments.length<2){if(arguments.length<1){checkPolicyFile = false;}applicationDomain = null;}securityDomain = null;}
