...
"public class Font",1,function($$private){;return[ 
   ...
   * </listing>
   */
  "public static function enumerateFonts",function enumerateFonts(enumerateDeviceFonts/*:Boolean = false*/)/*:Array*/ {if(arguments.length<1){enumerateDeviceFonts = false;}
    throw new Error('not implemented'); // TODO: implement!
  },
