...
"public class SharedObject extends flash.events.EventDispatcher",2,function($$private){;return[ 
   ...
   *
   */
  "public function get data",function data$get()/*:Object*/ {
    return this._data$2;
  },
   ...
   */
  "public function set fps",function fps$set(value/*:Number*/)/*:void*/ {
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   * </listing>
   */
  "public function get size",function size$get()/*:uint*/ {
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   *
   */
  "public function connect",function connect(myConnection/*:NetConnection*/, params/*:String = null*/)/*:void*/ {if(arguments.length<2){params = null;}
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   * </listing>
   */
  "public function flush",function flush(minDiskSpace/*:int = 0*/)/*:String*/ {if(arguments.length<1){minDiskSpace = 0;}
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   *
   */
  "public static function getLocal",function getLocal(name/*:String*/, localPath/*:String = null*/, secure/*:Boolean = false*/)/*:SharedObject*/ {if(arguments.length<3){if(arguments.length<2){localPath = null;}secure = false;}
   ...
   *
   */
  "public static function getRemote",function getRemote(name/*:String*/, remotePath/*:String = null*/, persistence/*:Object = false*/, secure/*:Boolean = false*/)/*:SharedObject*/ {if(arguments.length<4){if(arguments.length<3){if(arguments.length<2){remotePath = null;}persistence = false;}secure = false;}
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   *
   */
  "public function send",function send(/*...rest*/)/*:void*/ {var rest=arguments;
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   *
   */
  "public function setDirty",function setDirty(propertyName/*:String*/)/*:void*/ {
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   *
   */
  "public function setProperty",function setProperty(propertyName/*:String*/, value/*:Object = null*/)/*:void*/ {if(arguments.length<2){value = null;}
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   * @private
   */
  "public function SharedObject",function SharedObject$(data/*:Object*/) {this.super$2();
    this._data$2 = data;
  },
