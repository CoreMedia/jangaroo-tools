...
"public final class DropShadowFilter extends flash.filters.BitmapFilter",2,function($$private){;return[ 
   ...
   *
   */
  "public function DropShadowFilter",function DropShadowFilter$(distance/*:Number = 4.0*/, angle/*:Number = 45*/, color/*:uint = 0*/, alpha/*:Number = 1.0*/, blurX/*:Number = 4.0*/, blurY/*:Number = 4.0*/, strength/*:Number = 1.0*/, quality/*:int = 1*/, inner/*:Boolean = false*/, knockout/*:Boolean = false*/, hideObject/*:Boolean = false*/) {if(arguments.length<11){if(arguments.length<10){if(arguments.length<9){if(arguments.length<8){if(arguments.length<7){if(arguments.length<6){if(arguments.length<5){if(arguments.length<4){if(arguments.length<3){if(arguments.length<2){if(arguments.length<1){distance = 4.0;}angle = 45;}color = 0;}alpha = 1.0;}blurX = 4.0;}blurY = 4.0;}strength = 1.0;}quality = 1;}inner = false;}knockout = false;}hideObject = false;}this.super$2();
    throw new Error('not implemented'); // TODO: implement!
  },
