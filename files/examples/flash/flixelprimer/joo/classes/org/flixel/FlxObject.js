joo.classLoader.prepare("package org.flixel",/*
{
	...
	"public class FlxObject extends org.flixel.FlxRect",3,function($$private){;return[function(){joo.classLoader.init(org.flixel.FlxU,org.flixel.FlxG);},
		 ...
		 */
		"public function flicker",function flicker(Duration/*:Number=1*/)/*:void*/ {if(arguments.length<1){Duration=1;} this._flickerTimer = Duration; if(this._flickerTimer < 0) { this._flicker = false; this.visible = true; } },
