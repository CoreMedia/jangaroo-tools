...
];},["fromImg"],["flash.display.IBitmapDrawable","flash.geom.Rectangle","Error","Math","flash.display.Graphics","flash.display.Bitmap","flash.display.DisplayObject","js.HTMLImageElement","js.HTMLCanvasElement","js.Image","js.HTMLElement","js.CanvasRenderingContext2D"], "0.8.0", "0.8.3"
);
...
];},[],["flash.display.InteractiveObject","Error","flash.events.Event","flash.display.DisplayObject","ArgumentError","js.Element"], "0.8.0", "0.8.3"
);
...
canvas.width=Math.max(canvas.width,this.width+$$private.PIXEL_CHUNK_SIZE);
canvas.height=Math.max(canvas.height,this.height+$$private.PIXEL_CHUNK_SIZE);
...
];},["toRGBA"],["Math","flash.display.CapsStyle","flash.display.JointStyle","js.HTMLCanvasElement","js.CanvasRenderingContext2D","flash.geom.Point","flash.geom.Matrix","flash.display.GradientType"], "0.8.0", "0.8.3"
);
...
];},[],["flash.display.DisplayObject","Boolean","ArgumentError"], "0.8.0", "0.8.3"
);
...
];},[],["flash.display.DisplayObjectContainer","flash.display.LoaderInfo","joo.flash.util.Base64"], "0.8.0", "0.8.3"
);
...
];},["getLoaderInfoByDefinition"],["flash.events.EventDispatcher","Error","js.Image","flash.display.Bitmap","flash.display.BitmapData","flash.events.Event"], "0.8.0", "0.8.3"
);
...
];},[],["flash.display.Sprite","Error"], "0.8.0", "0.8.3"
);
...
];},[],["flash.display.DisplayObject","flash.display.Graphics"], "0.8.0", "0.8.3"
);
...
];},[],["flash.display.DisplayObjectContainer","Error","Number","int","flash.utils.Timer","flash.events.TimerEvent","String","flash.display.Graphics","uint","js.HTMLElement","flash.events.Event","flash.display.StageQuality","flash.display.StageScaleMode","flash.display.StageAlign"], "0.8.0", "0.8.3"
);
...
];},[],["flash.errors.IOError"], "0.8.0", "0.8.3"
);
...
];},[],["flash.events.ErrorEvent"], "0.8.0", "0.8.3"
);
...
];},[],["flash.events.IEventDispatcher"], "0.8.0", "0.8.3"
);
...
"public static const",{FULL_SCREEN:"fullScreen"},
];},[],["flash.events.ActivityEvent"], "0.8.0", "0.8.3"
);
...
];},[],["flash.events.Event","flash.display.DisplayObject"], "0.8.0", "0.8.3"
);
...
];},["available","objectID","addCallback","call"],["Error"], "0.8.0", "0.8.3"
);
...
];},[],["flash.geom.Rectangle"], "0.8.0", "0.8.3"
);
...
];},["bufferTime","soundTransform","areSoundsInaccessible","computeSpectrum","stopAll"],["Error"], "0.8.0", "0.8.3"
);
...
];},["defaultObjectEncoding"],["flash.events.EventDispatcher","Error"], "0.8.0", "0.8.3"
);
...
];},["dynamicPropertyWriter"],["Error"], "0.8.0", "0.8.3"
);
...
];},["defaultObjectEncoding","getLocal","getRemote"],["flash.events.EventDispatcher","Error"], "0.8.0", "0.8.3"
);
...
];},[],["flash.events.EventDispatcher","flash.utils.IDataInput","flash.utils.IDataOutput","Error"], "0.8.0", "0.8.3"
);
...
];},[],["flash.events.EventDispatcher","Error","js.XMLHttpRequest","flash.events.Event"], "0.8.0", "0.8.3"
);
...
];},[],["flash.net.URLRequestMethod"], "0.8.0", "0.8.3"
);
...
];},[],["flash.events.EventDispatcher","flash.utils.IDataInput","Error"], "0.8.0", "0.8.3"
);
...
];},["conversionMode","enabled","doConversion","setCompositionString"],["flash.events.EventDispatcher","Error"], "0.8.0", "0.8.3"
);
...
];},["exactSettings","sandboxType","allowDomain","allowInsecureDomain","loadPolicyFile","showSettings"],["Error"], "0.8.0", "0.8.3"
);
...
];},["ime","totalMemory","useCodePage","exit","gc","pause","resume","setClipboard"],["Error"], "0.8.0", "0.8.3"
);
...
];},["enumerateFonts","registerFont"],["Error"], "0.8.0", "0.8.3"
);
...
];},["displayMode","maxLevel","setAdvancedAntiAliasingTable"],["Error"], "0.8.0", "0.8.3"
);
...
"private var",{_length:0},
];},["defaultObjectEncoding"],["flash.utils.IDataInput","flash.utils.IDataOutput","Error"], "0.8.0", "0.8.3"
);
...
joo.classLoader.prepare("package flash.utils",
"public namespace flash_proxy","http://www.adobe.com/flash/proxy",[],[], "0.8.0", "0.8.3"
);
...
];},[],["flash.events.EventDispatcher","flash.events.TimerEvent"], "0.8.0", "0.8.3"
);
...
];},[],["flash.xml.XMLNode","flash.xml.XMLNodeType","Error"], "0.8.0", "0.8.3"
);
...
];},["main"],["joo.DynamicClassLoader","flash.display.Stage","flash.display.DisplayObject","flash.events.Event"], "0.8.0", "0.8.3"
);
