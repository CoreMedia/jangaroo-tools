...
"public class SoundLoaderContext",1,function($$private){;return[ 
   ...
   * </listing>
   */
  "public function SoundLoaderContext",function SoundLoaderContext$(bufferTime/*:Number = 1000*/, checkPolicyFile/*:Boolean = false*/) {if(arguments.length<2){if(arguments.length<1){bufferTime = 1000;}checkPolicyFile = false;}
