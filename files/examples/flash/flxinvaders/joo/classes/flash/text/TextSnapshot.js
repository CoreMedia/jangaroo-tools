...
"public class TextSnapshot",1,function($$private){;return[ 
   ...
   *
   */
  "public function getSelectedText",function getSelectedText(includeLineEndings/*:Boolean = false*/)/*:String*/ {if(arguments.length<1){includeLineEndings = false;}
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   *
   */
  "public function getText",function getText(beginIndex/*:int*/, endIndex/*:int*/, includeLineEndings/*:Boolean = false*/)/*:String*/ {if(arguments.length<3){includeLineEndings = false;}
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   *
   */
  "public function hitTestTextNearPos",function hitTestTextNearPos(x/*:Number*/, y/*:Number*/, maxDistance/*:Number = 0*/)/*:Number*/ {if(arguments.length<3){maxDistance = 0;}
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   *
   */
  "public function setSelectColor",function setSelectColor(hexColor/*:uint = 0xFFFF00*/)/*:void*/ {if(arguments.length<1){hexColor = 0xFFFF00;}
    throw new Error('not implemented'); // TODO: implement!
  },
