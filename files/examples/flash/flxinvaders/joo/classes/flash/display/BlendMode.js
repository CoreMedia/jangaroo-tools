 ...
 * <ul>
 * <li>The <code>blendMode</code> property of the flash.display.DisplayObject class.</li>
 * <li>The <code>blendMode</code> parameter of the <code>draw()</code> method of the flash.display.BitmapData class</li></ul>
...
"public final class BlendMode",1,function($$private){;return[ 
   ...
   * <p>For example, if the display object has a pixel with an RGB value of 0xAAA633, and the background pixel has an RGB value of 0xDD2200, the resulting RGB value for the displayed pixel is 0xFFC833 (because 0xAA + 0xDD > 0xFF, 0xA6 + 0x22 = 0xC8, and 0x33 + 0x00 = 0x33).</p>
   */
  "public static const",{ ADD/*:String*/ : "add"},
  /**
   * Applies the alpha value of each pixel of the display object to the background. This requires the <code>blendMode</code> property of the parent display object be set to <code>flash.display.BlendMode.LAYER</code>.
   ...
   * <p>For example, if the display object has a pixel with an RGB value of 0xFFCC33, and the background pixel has an RGB value of 0xDDF800, the resulting RGB value for the displayed pixel is 0x222C33 (because 0xFF - 0xDD = 0x22, 0xF8 - 0xCC = 0x2C, and 0x33 - 0x00 = 0x33).</p>
   */
  "public static const",{ DIFFERENCE/*:String*/ : "difference"},
  /**
   * Erases the background based on the alpha value of the display object. This process requires that the <code>blendMode</code> property of the parent display object be set to <code>flash.display.BlendMode.LAYER</code>.
   * <p>Not supported under GPU rendering.</p>
   */
