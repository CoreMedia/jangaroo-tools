...
"public final class GradientGlowFilter extends flash.filters.BitmapFilter",2,function($$private){;return[ 
   ...
   *
   */
  "public function GradientGlowFilter",function GradientGlowFilter$(distance/*:Number = 4.0*/, angle/*:Number = 45*/, colors/*:Array = null*/, alphas/*:Array = null*/, ratios/*:Array = null*/, blurX/*:Number = 4.0*/, blurY/*:Number = 4.0*/, strength/*:Number = 1*/, quality/*:int = 1*/, type/*:String = "inner"*/, knockout/*:Boolean = false*/) {if(arguments.length<11){if(arguments.length<10){if(arguments.length<9){if(arguments.length<8){if(arguments.length<7){if(arguments.length<6){if(arguments.length<5){if(arguments.length<4){if(arguments.length<3){if(arguments.length<2){if(arguments.length<1){distance = 4.0;}angle = 45;}colors = null;}alphas = null;}ratios = null;}blurX = 4.0;}blurY = 4.0;}strength = 1;}quality = 1;}type = "inner";}knockout = false;}this.super$2();
    throw new Error('not implemented'); // TODO: implement!
  },
