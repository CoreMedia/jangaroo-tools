...
"public class b2BuoyancyController extends Box2D.Dynamics.Controllers.b2Controller",2,function($$private){;return[function(){joo.classLoader.init(Number);},
	 ...
	 */
	"public var",{ normal/*:b2Vec2*/ :function(){return( new Box2D.Common.Math.b2Vec2(0,-1));}},
	/**
	 ...
	 */
	"public var",{ velocity/*:b2Vec2*/ :function(){return( new Box2D.Common.Math.b2Vec2(0,0));}},
	/**
	...
	"public override function Step",function Step(step/*:b2TimeStep*/)/*:void*/{
		...
		for (this.m_iterator$2 = this.m_bodyIterable.ResetIterator(this.m_iterator$2); this.m_iterator$2.HasNext(); )
		{
			...
			var areac/*:b2Vec2*/ = new Box2D.Common.Math.b2Vec2();
			var massc/*:b2Vec2*/ = new Box2D.Common.Math.b2Vec2();
			var area/*:Number*/ = 0.0;
			var mass/*:Number*/ = 0.0;
			for(var fixture/*:b2Fixture*/ =body.GetFixtureList();fixture;fixture=fixture.GetNext()){
				var sc/*:b2Vec2*/ = new Box2D.Common.Math.b2Vec2();
	...
	"public override function Draw",function Draw(debugDraw/*:b2DebugDraw*/)/*:void*/
	{
		var r/*:Number*/ = 1000;
		//Would like to draw a semi-transparent box
		//But debug draw doesn't support that
		var p1/*:b2Vec2*/ = new Box2D.Common.Math.b2Vec2();
		var p2/*:b2Vec2*/ = new Box2D.Common.Math.b2Vec2();
		p1.x = this.normal.x * this.offset + this.normal.y * r;
		p1.y = this.normal.y * this.offset - this.normal.x * r;
		p2.x = this.normal.x * this.offset - this.normal.y * r;
		p2.y = this.normal.y * this.offset + this.normal.x * r;
		var color/*:b2Color*/ = new Box2D.Common.b2Color(0,0,1);
