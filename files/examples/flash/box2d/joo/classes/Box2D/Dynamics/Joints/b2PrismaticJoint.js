...
"public class b2PrismaticJoint extends Box2D.Dynamics.Joints.b2Joint",2,function($$private){;return[function(){joo.classLoader.init(Number,Box2D.Common.b2Settings);},
	...
	*/
	...
	/** @private */
	"public function b2PrismaticJoint",function b2PrismaticJoint$(def/*:b2PrismaticJointDef*/){
	...
	"b2internal override function InitVelocityConstraints",function InitVelocityConstraints(step/*:b2TimeStep*/)/* : void*/{
		...
		if (step.warmStarting)
		{
			...
			var PX/*:Number*/ = this.m_impulse$2.x * this.m_perp$2.x + (this.m_motorImpulse$2 + this.m_impulse$2.z) * this.m_axis$2.x;
			var PY/*:Number*/ = this.m_impulse$2.x * this.m_perp$2.y + (this.m_motorImpulse$2 + this.m_impulse$2.z) * this.m_axis$2.y;
			var L1/*:Number*/ = this.m_impulse$2.x * this.m_s1$2 + this.m_impulse$2.y + (this.m_motorImpulse$2 + this.m_impulse$2.z) * this.m_a1$2;
			var L2/*:Number*/ = this.m_impulse$2.x * this.m_s2$2 + this.m_impulse$2.y + (this.m_motorImpulse$2 + this.m_impulse$2.z) * this.m_a2$2; 
	...
	"private static var",{ s_f2r/*:b2Vec2*/ :function(){return( new Box2D.Common.Math.b2Vec2());}},
	"private static var",{ s_f1/*:b2Vec3*/ :function(){return( new Box2D.Common.Math.b2Vec3());}},
	"b2internal override function SolveVelocityConstraints",function SolveVelocityConstraints(step/*:b2TimeStep*/)/* : void*/{
		...
		var Cdot1X/*:Number*/ = this.m_perp$2.x * (v2.x - v1.x) + this.m_perp$2.y * (v2.y - v1.y) + this.m_s2$2 * w2 - this.m_s1$2 * w1; 
		...
		if (this.m_enableLimit$2 && this.m_limitState$2 != Box2D.Dynamics.Joints.b2Joint.e_inactiveLimit)
		{
			...
			var f1/*:b2Vec3*/ = $$private.s_f1;
			f1.SetV(this.m_impulse$2);
			var df/*:b2Vec3*/ = this.m_K$2.Solve33($$private.s_vec3, -Cdot1X, -Cdot1Y, -Cdot2);
			...
			var bX/*:Number*/ = -Cdot1X - (this.m_impulse$2.z - f1.z) * this.m_K$2.col3.x;
			var bY/*:Number*/ = -Cdot1Y - (this.m_impulse$2.z - f1.z) * this.m_K$2.col3.y;
			var f2r/*:b2Vec2*/ = this.m_K$2.Solve22($$private.s_f2r, bX, bY);
			f2r.x += f1.x;
			f2r.y += f1.y;
		...
		else
		{
			...
			var df2/*:b2Vec2*/ = this.m_K$2.Solve22($$private.s_f2r, -Cdot1X, -Cdot1Y);
	...
	"private static var",{ s_R1/*:b2Mat22*/ :function(){return( new Box2D.Common.Math.b2Mat22());}},
	"private static var",{ s_R2/*:b2Mat22*/ :function(){return( new Box2D.Common.Math.b2Mat22());}},
	"private static var",{ s_vec3/*:b2Vec3*/ :function(){return( new Box2D.Common.Math.b2Vec3());}},
	"b2internal override function SolvePositionConstraints",function SolvePositionConstraints(baumgarte/*:Number*/ )/*:Boolean*/
	{
		...
		var R1/*:b2Mat22*/ = $$private.s_R1;
		var R2/*:b2Mat22*/ = $$private.s_R2;
		R1.Set(a1);
		R2.Set(a2);
		...
		var impulse/*:b2Vec3*/ = $$private.s_vec3;
		var C1X/*:Number*/ = this.m_perp$2.x * dX + this.m_perp$2.y * dY;
		var C1Y/*:Number*/ = a2 - a1 - this.m_refAngle$2;
		...
		else
		{
			...
			var k12/*:Number*/ = i1 * this.m_s1$2 + i2 * this.m_s2$2;
			var k22/*:Number*/ = i1 + i2; 
			
			this.m_K$2.col1.Set(k11, k12, 0.0);
			this.m_K$2.col2.Set(k12, k22, 0.0);
			
			var impulse1/*:b2Vec2*/ = this.m_K$2.Solve22(new Box2D.Common.Math.b2Vec2(), -C1X, -C1Y);
			impulse.x = impulse1.x;
			impulse.y = impulse1.y;
			impulse.z = 0.0;
		}
		
		var PX/*:Number*/ = impulse.x * this.m_perp$2.x + impulse.z * this.m_axis$2.x;
		var PY/*:Number*/ = impulse.x * this.m_perp$2.y + impulse.z * this.m_axis$2.y;
		var L1/*:Number*/ = impulse.x * this.m_s1$2 + impulse.y + impulse.z * this.m_a1$2;
		var L2/*:Number*/ = impulse.x * this.m_s2$2 + impulse.y + impulse.z * this.m_a2$2;
	...
	"private var",{ m_refAngle/*:Number*/:NaN},
	...
	"private var",{ m_K/*:b2Mat33*/ :function(){return( new Box2D.Common.Math.b2Mat33());}},
