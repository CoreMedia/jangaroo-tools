...
"public class b2WeldJoint extends Box2D.Dynamics.Joints.b2Joint",2,function($$private){;return[function(){joo.classLoader.init(Box2D.Common.b2Settings);},
	...
	/** @private */
	"public function b2WeldJoint",function b2WeldJoint$(def/*:b2WeldJointDef*/){
	...
	"b2internal override function SolveVelocityConstraints",function SolveVelocityConstraints(step/*:b2TimeStep*/)/*: void*/{
		...
		var impulse/*:b2Vec3*/ = new Box2D.Common.Math.b2Vec3();
	...
	"b2internal override function SolvePositionConstraints",function SolvePositionConstraints(baumgarte/*:Number*/)/*:Boolean*/
	{
		...
		var C2/*:Number*/ = bB.m_sweep.a - bA.m_sweep.a - this.m_referenceAngle$2;

		// Handle large detachment.
		var k_allowedStretch/*:Number*/ = 10.0 * Box2D.Common.b2Settings.b2_linearSlop;
		var positionError/*:Number*/ = Math.sqrt(C1X * C1X + C1Y * C1Y);
		var angularError/*:Number*/ = Box2D.Common.Math.b2Math.Abs(C2);
	...
	"private var",{ m_mass/*:b2Mat33*/ :function(){return( new Box2D.Common.Math.b2Mat33());}},
