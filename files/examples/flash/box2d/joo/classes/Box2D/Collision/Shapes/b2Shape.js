...
"public class b2Shape",1,function($$private){;return[function(){joo.classLoader.init(Number,Box2D.Common.b2Settings);},
	 ...
	 * Clone the shape
	 */
	"virtual public function Copy",function Copy()/*:b2Shape*/
	{
	 ...
	 */
	"virtual public function Set",function Set(other/*:b2Shape*/)/*:void*/
	{
		//Don't copy m_type?
		//m_type = other.m_type;
	...
	"virtual public function MulBy",function MulBy(xf/*:b2Transform*/)/*:void*/ {},
	
	"virtual public function ScaleBy",function ScaleBy(scale/*:Number*/)/*:void*/ { },
	
	"virtual public function ReflectX",function ReflectX()/*:void*/ { },
	...
	*/
	"public virtual function TestPoint",function TestPoint(xf/*:b2Transform*/, p/*:b2Vec2*/)/* : Boolean*/ {return false;},
	 ...
	 */
	"public virtual function RayCast",function RayCast(output/*:b2RayCastOutput*/, input/*:b2RayCastInput*/, transform/*:b2Transform*/)/*:Boolean*/
	{
		return false;
	},
	...
	*/
	"public virtual function  ComputeAABB",function ComputeAABB(aabb/*:b2AABB*/, xf/*:b2Transform*/)/* : void*/ {},
	...
	*/
	"public virtual function ComputeMass",function ComputeMass(massData/*:b2MassData*/, density/*:Number*/)/* : void*/ { },
	 ...
	 */
	"public virtual function ComputeSubmergedArea",function ComputeSubmergedArea(
				normal/*:b2Vec2*/,
				offset/*:Number*/,
				xf/*:b2Transform*/,
				c/*:b2Vec2*/)/*:Number*/ { return 0; },
				
	"public static function TestOverlap",function TestOverlap(shape1/*:b2Shape*/, transform1/*:b2Transform*/, shape2/*:b2Shape*/, transform2/*:b2Transform*/)/*:Boolean*/
	{
		var input/*:b2DistanceInput*/ = new Box2D.Collision.b2DistanceInput();
		...
		input.useRadii = true;
		var simplexCache/*:b2SimplexCache*/ = new Box2D.Collision.b2SimplexCache();
		simplexCache.count = 0;
		var output/*:b2DistanceOutput*/ = new Box2D.Collision.b2DistanceOutput();
	 ...
	 * @private
	 */
	"public function b2Shape",function b2Shape$()
	{
	...
	"b2internal var",{ m_radius/*:Number*/:NaN},
