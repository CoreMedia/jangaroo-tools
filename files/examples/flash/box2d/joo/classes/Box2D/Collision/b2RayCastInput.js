...
"package Box2D.Collision",/* 
{
	...
	"public class b2RayCastInput",1,function($$private){;return[ 
		...
		"function b2RayCastInput",function b2RayCastInput$(p1/*:b2Vec2 = null*/, p2/*:b2Vec2 = null*/, maxFraction/*:Number = 1*/)
		 ...
		 */
		"public var",{ p1/*:b2Vec2*/ :function(){return( new Box2D.Common.Math.b2Vec2());}},
		/**
		 * The end point of the ray
		 */
		"public var",{ p2/*:b2Vec2*/ :function(){return( new Box2D.Common.Math.b2Vec2());}},
		/**
		 * Truncate the ray to reach up to this fraction from p1 to p2
		 */
		"public var",{ maxFraction/*:Number*/:NaN},
