...
"public class b2Collision",1,function($$private){;return[function(){joo.classLoader.init(Box2D.Collision.b2Manifold,Number,Box2D.Common.b2Settings);},
	...
	"static public function ClipSegmentToLine",function ClipSegmentToLine(vOut/*:Array*//*ClipVertex*/, vIn/*:Array*//*ClipVertex*/, normal/*:b2Vec2*/, offset/*:Number*/)/*:int*/
	{
		var cv/*:ClipVertex*/;
	...
	"static public function EdgeSeparation",function EdgeSeparation(	poly1/*:b2PolygonShape*/, xf1/*:b2Transform*/, edge1/*:int*/, 
	...
	// from poly1.
	"static public function FindMaxSeparation",function FindMaxSeparation(edgeIndex/*:Array*//*int*/, 
											...
											poly2/*:b2PolygonShape*/, xf2/*:b2Transform*/)/*:Number*/
	{
		...
		var s/*:Number*/ = Box2D.Collision.b2Collision.EdgeSeparation(poly1, xf1, edge, poly2, xf2);
		
		// Check the separation for the previous edge normal.
		var prevEdge/*:int*/ = edge - 1 >= 0 ? edge - 1 : count1 - 1;
		var sPrev/*:Number*/ = Box2D.Collision.b2Collision.EdgeSeparation(poly1, xf1, prevEdge, poly2, xf2);
		
		// Check the separation for the next edge normal.
		var nextEdge/*:int*/ = edge + 1 < count1 ? edge + 1 : 0;
		var sNext/*:Number*/ = Box2D.Collision.b2Collision.EdgeSeparation(poly1, xf1, nextEdge, poly2, xf2);
	...
	"static public function FindIncidentEdge",function FindIncidentEdge(c/*:Array*//*ClipVertex*/, 
	...
	"private static function MakeClipPointVector",function MakeClipPointVector()/*:Array*//*ClipVertex*/
	{
	...
	"private static var",{ s_incidentEdge/*:Array*//*ClipVertex*/ :function(){return( $$private.MakeClipPointVector());}},
	"private static var",{ s_clipPoints1/*:Array*//*ClipVertex*/ :function(){return( $$private.MakeClipPointVector());}},
	"private static var",{ s_clipPoints2/*:Array*//*ClipVertex*/ :function(){return( $$private.MakeClipPointVector());}},
	"private static var",{ s_edgeAO/*:Array*//*int*/ :function(){return( new Array/*int*/(1));}},
	"private static var",{ s_edgeBO/*:Array*//*int*/ :function(){return( new Array/*int*/(1));}},
	"private static var",{ s_localTangent/*:b2Vec2*/ :function(){return( new Box2D.Common.Math.b2Vec2());}},
	"private static var",{ s_localNormal/*:b2Vec2*/ :function(){return( new Box2D.Common.Math.b2Vec2());}},
	"private static var",{ s_planePoint/*:b2Vec2*/ :function(){return( new Box2D.Common.Math.b2Vec2());}},
	"private static var",{ s_normal/*:b2Vec2*/ :function(){return( new Box2D.Common.Math.b2Vec2());}},
	"private static var",{ s_tangent/*:b2Vec2*/ :function(){return( new Box2D.Common.Math.b2Vec2());}},
	"private static var",{ s_tangent2/*:b2Vec2*/ :function(){return( new Box2D.Common.Math.b2Vec2());}},
	"private static var",{ s_v11/*:b2Vec2*/ :function(){return( new Box2D.Common.Math.b2Vec2());}},
	"private static var",{ s_v12/*:b2Vec2*/ :function(){return( new Box2D.Common.Math.b2Vec2());}},
	// Find edge normal of max separation on A - return if separating axis is found
	// Find edge normal of max separation on B - return if separation axis is found
	// Choose reference edge as min(minA, minB)
	// Find incident edge
	// Clip
	"static private var",{ b2CollidePolyTempVec/*:b2Vec2*/ :function(){return( new Box2D.Common.Math.b2Vec2());}},
	// The normal points from 1 to 2
	"static public function CollidePolygons",function CollidePolygons(manifold/*:b2Manifold*/, 
											...
											polyB/*:b2PolygonShape*/, xfB/*:b2Transform*/)/* : void*/
	{
		...
		var separationA/*:Number*/ = Box2D.Collision.b2Collision.FindMaxSeparation($$private.s_edgeAO, polyA, xfA, polyB, xfB);
		...
		var separationB/*:Number*/ = Box2D.Collision.b2Collision.FindMaxSeparation($$private.s_edgeBO, polyB, xfB, polyA, xfA);
		...
		var flip/*:uint*/;/*
		const*/var k_relativeTol/*:Number*/ = 0.98;/*
		const*/var k_absoluteTol/*:Number*/ = 0.001;
		var tMat/*:b2Mat22*/;
		...
		var incidentEdge/*:Array*//*ClipVertex*/ = $$private.s_incidentEdge; 
		...
		var localTangent/*:b2Vec2*/ = $$private.s_localTangent;
		localTangent.Set(local_v12.x - local_v11.x, local_v12.y - local_v11.y);
		localTangent.Normalize();
		
		var localNormal/*:b2Vec2*/ = $$private.s_localNormal;
		localNormal.x = localTangent.y;
		localNormal.y = -localTangent.x;
		
		var planePoint/*:b2Vec2*/ = $$private.s_planePoint;
		planePoint.Set(0.5 * (local_v11.x + local_v12.x), 0.5 * (local_v11.y + local_v12.y));
		
		var tangent/*:b2Vec2*/ = $$private.s_tangent;
		//tangent = b2Math.b2MulMV(xf1.R, localTangent);
		tMat = xf1.R;
		tangent.x = (tMat.col1.x * localTangent.x + tMat.col2.x * localTangent.y);
		tangent.y = (tMat.col1.y * localTangent.x + tMat.col2.y * localTangent.y);
		var tangent2/*:b2Vec2*/ = $$private.s_tangent2;
		tangent2.x = - tangent.x;
		tangent2.y = - tangent.y;
		var normal/*:b2Vec2*/ = $$private.s_normal;
		normal.x = tangent.y;
		normal.y = -tangent.x;

		//v11 = b2Math.MulX(xf1, local_v11);
		//v12 = b2Math.MulX(xf1, local_v12);
		var v11/*:b2Vec2*/ = $$private.s_v11;
		var v12/*:b2Vec2*/ = $$private.s_v12;
		...
		var clipPoints1/*:Array*//*ClipVertex*/ = $$private.s_clipPoints1;
		var clipPoints2/*:Array*//*ClipVertex*/ = $$private.s_clipPoints2;
		var np/*:int*/;
	...
	"static public function CollideCircles",function CollideCircles(
		manifold/*:b2Manifold*/, 
	...
	"static public function CollidePolygonAndCircle",function CollidePolygonAndCircle(
		manifold/*:b2Manifold*/, 
	...
	"static public function TestOverlap",function TestOverlap(a/*:b2AABB*/, b/*:b2AABB*/)/*:Boolean*/
	{
