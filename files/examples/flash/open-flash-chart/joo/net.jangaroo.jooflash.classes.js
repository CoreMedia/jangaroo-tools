...
];},["active","sendEvent","updateProperties"],["flash.errors.IllegalOperationError"], "0.8.0", "0.8.4"
);
...
];},[],["flash.display.DisplayObject"], "0.8.0", "0.8.4"
);
...
"public function BitmapData",function(width,height,transparent,fillColor){if(arguments.length<4){if(arguments.length<3){transparent=true;}fillColor=0xFFFFFFFF;}this.elementChangeListeners$1=this.elementChangeListeners$1();
...
];},["fromImg"],["flash.display.IBitmapDrawable","flash.geom.Rectangle","Error","Math","flash.display.Graphics","flash.display.Bitmap","flash.display.DisplayObject","js.HTMLImageElement","js.HTMLCanvasElement","js.Image","js.HTMLElement","js.CanvasRenderingContext2D"], "0.8.0", "0.8.4"
);
...
return $$private._loaderInfo||($$private._loaderInfo=new flash.display.LoaderInfo());
},
...
];},[],["flash.events.EventDispatcher","flash.display.IBitmapDrawable","Error","String","flash.display.LoaderInfo","flash.geom.Transform","flash.geom.Rectangle","flash.events.MouseEvent","flash.events.KeyboardEvent","flash.events.Event","flash.display.Stage","Number","js.HTMLElement","flash.geom.Point","flash.display.BlendMode"], "0.8.0", "0.8.4"
);
...
];},[],["flash.display.InteractiveObject","Error","flash.events.Event","flash.display.DisplayObject","ArgumentError","js.Element"], "0.8.0", "0.8.4"
);
...
this.startX$1=this.x$1=x;
this.startY$1=this.y$1=y;
this.scheduleCommand$1(function(){
this$.context$1.moveTo(x,y);
});
},
...
];},["toRGBA"],["Math","flash.display.CapsStyle","flash.display.JointStyle","js.HTMLCanvasElement","js.CanvasRenderingContext2D","flash.geom.Point","flash.geom.Matrix","flash.display.GradientType"], "0.8.0", "0.8.4"
);
...
];},[],["flash.display.DisplayObject","Boolean","ArgumentError"], "0.8.0", "0.8.4"
);
...
];},[],["flash.display.DisplayObjectContainer","flash.display.LoaderInfo","joo.flash.util.Base64"], "0.8.0", "0.8.4"
);
...
"public function LoaderInfo",function(loader){if(arguments.length<1){loader=null;}this.super$2();
this['loader']=loader;
...
];},["getLoaderInfoByDefinition"],["flash.events.EventDispatcher","Error","String","js.Image","flash.display.Bitmap","flash.display.BitmapData","flash.events.Event"], "0.8.0", "0.8.4"
);
...
];},[],["flash.display.Sprite","Error"], "0.8.0", "0.8.4"
);
...
];},[],["flash.display.DisplayObject","flash.display.Graphics"], "0.8.0", "0.8.4"
);
...
];},[],["flash.display.InteractiveObject"], "0.8.0", "0.8.4"
);
...
];},[],["flash.display.DisplayObjectContainer","Error","flash.display.Graphics"], "0.8.0", "0.8.4"
);
...
"public class Stage extends flash.display.DisplayObjectContainer",5,function($$private){;return[function(){joo.classLoader.init(flash.display.StageScaleMode,flash.display.StageQuality,flash.display.StageAlign,flash.events.Event,flash.events.TimerEvent);},
...
];},["addEnterFrameSource","removeEnterFrameSource"],["flash.display.DisplayObjectContainer","Error","Number","int","flash.utils.Timer","flash.events.TimerEvent","String","flash.display.Graphics","uint","js.HTMLElement","flash.display.StageQuality","flash.display.StageScaleMode","flash.display.StageAlign","flash.events.Event"], "0.8.0", "0.8.4"
);
...
];},[],["flash.errors.IOError"], "0.8.0", "0.8.4"
);
...
];},[],["flash.events.ErrorEvent"], "0.8.0", "0.8.4"
);
...
];},[],["flash.events.TextEvent"], "0.8.0", "0.8.4"
);
...
"public static const",{FULL_SCREEN:"fullScreen"},
];},[],["flash.events.ActivityEvent"], "0.8.0", "0.8.4"
);
...
];},[],["flash.events.Event","flash.display.DisplayObject"], "0.8.0", "0.8.4"
);
...
];},["available","objectID","addCallback","call"],["Function"], "0.8.0", "0.8.4"
);
...
"public function BevelFilter",function(distance,angle,highlightColor,highlightAlpha,shadowColor,shadowAlpha,blurX,blurY,strength,quality,type,knockout){if(arguments.length<12){if(arguments.length<11){if(arguments.length<10){if(arguments.length<9){if(arguments.length<8){if(arguments.length<7){if(arguments.length<6){if(arguments.length<5){if(arguments.length<4){if(arguments.length<3){if(arguments.length<2){if(arguments.length<1){distance=4.0;}angle=45;}highlightColor=0xFFFFFF;}highlightAlpha=1.0;}shadowColor=0x000000;}shadowAlpha=1.0;}blurX=4.0;}blurY=4.0;}strength=1;}quality=1;}type="inner";}knockout=false;}this.super$2();
throw new Error('not implemented');
},
"override public function clone",function(){
throw new Error('not implemented');
},
];},[],["flash.filters.BitmapFilter","Error"], "0.8.0", "0.8.4"
);
...
"public function BlurFilter",function(blurX,blurY,quality){if(arguments.length<3){if(arguments.length<2){if(arguments.length<1){blurX=4.0;}blurY=4.0;}quality=1;}this.super$2();
throw new Error('not implemented');
},
"override public function clone",function(){
throw new Error('not implemented');
...
"public function ColorMatrixFilter",function(matrix){if(arguments.length<1){matrix=null;}this.super$2();
throw new Error('not implemented');
},
"override public function clone",function(){
throw new Error('not implemented');
...
"public function ConvolutionFilter",function(matrixX,matrixY,matrix,divisor,bias,preserveAlpha,clamp,color,alpha){if(arguments.length<9){if(arguments.length<8){if(arguments.length<7){if(arguments.length<6){if(arguments.length<5){if(arguments.length<4){if(arguments.length<3){if(arguments.length<2){if(arguments.length<1){matrixX=0;}matrixY=0;}matrix=null;}divisor=1.0;}bias=0.0;}preserveAlpha=true;}clamp=true;}color=0;}alpha=0.0;}this.super$2();
throw new Error('not implemented');
},
"override public function clone",function(){
throw new Error('not implemented');
...
"public function DisplacementMapFilter",function(mapBitmap,mapPoint,componentX,componentY,scaleX,scaleY,mode,color,alpha){if(arguments.length<9){if(arguments.length<8){if(arguments.length<7){if(arguments.length<6){if(arguments.length<5){if(arguments.length<4){if(arguments.length<3){if(arguments.length<2){if(arguments.length<1){mapBitmap=null;}mapPoint=null;}componentX=0;}componentY=0;}scaleX=0.0;}scaleY=0.0;}mode="wrap";}color=0;}alpha=0.0;}this.super$2();
throw new Error('not implemented');
},
"override public function clone",function(){
throw new Error('not implemented');
...
"public function DropShadowFilter",function(distance,angle,color,alpha,blurX,blurY,strength,quality,inner,knockout,hideObject){if(arguments.length<11){if(arguments.length<10){if(arguments.length<9){if(arguments.length<8){if(arguments.length<7){if(arguments.length<6){if(arguments.length<5){if(arguments.length<4){if(arguments.length<3){if(arguments.length<2){if(arguments.length<1){distance=4.0;}angle=45;}color=0;}alpha=1.0;}blurX=4.0;}blurY=4.0;}strength=1.0;}quality=1;}inner=false;}knockout=false;}hideObject=false;}this.super$2();
...
];},[],["flash.filters.BitmapFilter"], "0.8.0", "0.8.4"
);
...
"public function GlowFilter",function(color,alpha,blurX,blurY,strength,quality,inner,knockout){if(arguments.length<8){if(arguments.length<7){if(arguments.length<6){if(arguments.length<5){if(arguments.length<4){if(arguments.length<3){if(arguments.length<2){if(arguments.length<1){color=0xFF0000;}alpha=1.0;}blurX=6.0;}blurY=6.0;}strength=2;}quality=1;}inner=false;}knockout=false;}this.super$2();
throw new Error('not implemented');
},
"override public function clone",function(){
throw new Error('not implemented');
...
"public function GradientBevelFilter",function(distance,angle,colors,alphas,ratios,blurX,blurY,strength,quality,type,knockout){if(arguments.length<11){if(arguments.length<10){if(arguments.length<9){if(arguments.length<8){if(arguments.length<7){if(arguments.length<6){if(arguments.length<5){if(arguments.length<4){if(arguments.length<3){if(arguments.length<2){if(arguments.length<1){distance=4.0;}angle=45;}colors=null;}alphas=null;}ratios=null;}blurX=4.0;}blurY=4.0;}strength=1;}quality=1;}type="inner";}knockout=false;}this.super$2();
throw new Error('not implemented');
},
"override public function clone",function(){
throw new Error('not implemented');
...
];},[],["Math","flash.geom.Point"], "0.8.0", "0.8.4"
);
...
];},["distance","interpolate","polar"],["Math","Error"], "0.8.0", "0.8.4"
);
...
];},[],["flash.geom.Rectangle"], "0.8.0", "0.8.4"
);
...
];},["names","getCamera"],["flash.events.EventDispatcher","Error"], "0.8.0", "0.8.4"
);
...
];},["names","getMicrophone"],["flash.events.EventDispatcher","Error"], "0.8.0", "0.8.4"
);
...
"public function Sound",function(stream,context){if(arguments.length<2){if(arguments.length<1){stream=null;}context=null;}this.super$2();
if(!this.audio){
...
];},[],["flash.events.EventDispatcher","Error","flash.media.ID3Info","js.Audio"], "0.8.0", "0.8.4"
);
...
];},[],["flash.events.EventDispatcher","Error"], "0.8.0", "0.8.4"
);
...
];},["bufferTime","soundTransform","areSoundsInaccessible","computeSpectrum","stopAll"],["Error"], "0.8.0", "0.8.4"
);
...
"public function Video",function(width,height){if(arguments.length<2){if(arguments.length<1){width=320;}height=240;}this.super$3();
throw new Error('not implemented');
},
...
];},[],["flash.display.DisplayObject","Error"], "0.8.0", "0.8.4"
);
...
];},["defaultObjectEncoding"],["flash.events.EventDispatcher","Error"], "0.8.0", "0.8.4"
);
...
"public function NetStream",function(connection,peerID){if(arguments.length<2){peerID="connectToFMS";}this.super$2();
throw new Error('not implemented');
},
...
];},["dynamicPropertyWriter"],["Error"], "0.8.0", "0.8.4"
);
...
];},["defaultObjectEncoding","getLocal","getRemote"],["flash.events.EventDispatcher","Error"], "0.8.0", "0.8.4"
);
...
"public function Socket",function(host,port){if(arguments.length<2){if(arguments.length<1){host=null;}port=0;}this.super$2();
throw new Error('not implemented');
},
"public function close",function(){
throw new Error('not implemented');
...
];},[],["flash.events.EventDispatcher","flash.utils.IDataInput","flash.utils.IDataOutput","Error"], "0.8.0", "0.8.4"
);
...
"public function URLLoader",function(request){if(arguments.length<1){request=null;}this.super$2();
if(request){
this.load(request);
}
},
...
];},[],["flash.events.EventDispatcher","js.XMLHttpRequest","Error","flash.events.Event","flash.events.IOErrorEvent"], "0.8.0", "0.8.4"
);
...
];},[],["flash.net.URLRequestMethod"], "0.8.0", "0.8.4"
);
...
];},[],["flash.events.EventDispatcher","flash.utils.IDataInput","Error"], "0.8.0", "0.8.4"
);
...
"public function XMLSocket",function(host,port){if(arguments.length<2){if(arguments.length<1){host=null;}port=0;}this.super$2();
throw new Error('not implemented');
},
"public function close",function(){
throw new Error('not implemented');
...
];},["currentDomain"],["Error"], "0.8.0", "0.8.4"
);
...
];},["conversionMode","enabled","doConversion","setCompositionString"],["flash.events.EventDispatcher","Error"], "0.8.0", "0.8.4"
);
...
];},["exactSettings","sandboxType","allowDomain","allowInsecureDomain","loadPolicyFile","showSettings"],["Error"], "0.8.0", "0.8.4"
);
...
];},["ime","totalMemory","useCodePage","exit","gc","pause","resume","setClipboard"],["Error"], "0.8.0", "0.8.4"
);
...
];},["enumerateFonts","registerFont"],["Error"], "0.8.0", "0.8.4"
);
...
];},[],["flash.display.InteractiveObject","flash.display.Graphics","uint","Error","js.CanvasRenderingContext2D","js.HTMLCanvasElement","flash.text.TextLineMetrics","int","flash.text.TextFormat","flash.text.TextFormatAlign"], "0.8.0", "0.8.4"
);
...
];},["displayMode","maxLevel","setAdvancedAntiAliasingTable"],["Error"], "0.8.0", "0.8.4"
);
...
"public function ContextMenuItem",function(caption,separatorBefore,enabled,visible){if(arguments.length<4){if(arguments.length<3){if(arguments.length<2){separatorBefore=false;}enabled=true;}visible=true;}this.super$2();
...
];},["capsLock","numLock","isAccessible"],["Error"], "0.8.0", "0.8.4"
);
...
"private var",{_length:0},
];},["defaultObjectEncoding"],["flash.utils.IDataInput","flash.utils.IDataOutput","Error"], "0.8.0", "0.8.4"
);
...
joo.classLoader.prepare("package flash.utils",
"public namespace flash_proxy","http://www.adobe.com/flash/proxy",[],[], "0.8.0", "0.8.4"
);
...
"public function Timer",function(delay,repeatCount){if(arguments.length<2){repeatCount=0;}this.super$2();
this._delay$2=delay;
...
];},[],["flash.events.EventDispatcher","flash.events.TimerEvent"], "0.8.0", "0.8.4"
);
...
];},[],["flash.xml.XMLNode","flash.xml.XMLNodeType","Error"], "0.8.0", "0.8.4"
);
...
];},["embed"],["joo.DynamicClassLoader","String","js.HTMLImageElement","flash.display.Bitmap","flash.display.BitmapData","js.HTMLAudioElement","flash.media.Sound"], "0.8.0", "0.8.4"
);
// class joo.flash.Run
joo.classLoader.prepare("package joo.flash",
...
];},["main"],["joo.DynamicClassLoader","flash.display.Stage","flash.display.DisplayObject","flash.events.Event"], "0.8.0", "0.8.4"
);
...
];},["encodeBytes","encode","decode"],["String"], "0.8.0", "0.8.4"
);
