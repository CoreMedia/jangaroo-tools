...
"public class AsyncErrorEvent extends flash.events.ErrorEvent",4,function($$private){;return[ 
   ...
   *
   */
  "public function AsyncErrorEvent",function AsyncErrorEvent$(type/*:String*/, bubbles/*:Boolean = false*/, cancelable/*:Boolean = false*/, text/*:String = ""*/, error/*:Error = null*/) {switch(arguments.length){case 0:case 1:bubbles = false;case 2:cancelable = false;case 3:text = "";case 4:error = null;}
