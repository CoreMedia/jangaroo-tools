...
"public class HTTPStatusEvent extends flash.events.Event",2,function($$private){;return[ 
   ...
   *
   */
  "public function HTTPStatusEvent",function HTTPStatusEvent$(type/*:String*/, bubbles/*:Boolean = false*/, cancelable/*:Boolean = false*/, status/*:int = 0*/) {switch(arguments.length){case 0:case 1:bubbles = false;case 2:cancelable = false;case 3:status = 0;}
