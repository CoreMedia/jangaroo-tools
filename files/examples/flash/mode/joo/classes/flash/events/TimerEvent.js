...
"public class TimerEvent extends flash.events.Event",2,function($$private){;return[ 
   ...
   *
   */
  "public function TimerEvent",function TimerEvent$(type/*:String*/, bubbles/*:Boolean = false*/, cancelable/*:Boolean = false*/) {switch(arguments.length){case 0:case 1:bubbles = false;case 2:cancelable = false;}
