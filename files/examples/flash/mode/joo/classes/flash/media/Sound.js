...
"public class Sound extends flash.events.EventDispatcher",2,function($$private){;return[ 
   ...
   *
   */
  "public function Sound",function Sound$(stream/*:URLRequest = null*/, context/*:SoundLoaderContext = null*/) {switch(arguments.length){case 0:stream = null;case 1:context = null;}this.super$2();
   ...
   * </listing>
   */
  "public function load",function load(stream/*:URLRequest*/, context/*:SoundLoaderContext = null*/)/*:void*/ {switch(arguments.length){case 0:case 1:context = null;}
   ...
   * </listing></div>
   */
  "public function play",function play(startTime/*:Number = 0*/, loops/*:int = 0*/, sndTransform/*:SoundTransform = null*/)/*:SoundChannel*/ {switch(arguments.length){case 0:startTime = 0;case 1:loops = 0;case 2:sndTransform = null;}
    this.audio['play']();
    return null;
  },
