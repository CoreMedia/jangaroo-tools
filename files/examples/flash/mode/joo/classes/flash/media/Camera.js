...
"public final class Camera extends flash.events.EventDispatcher",2,function($$private){;return[ 
   ...
   * </listing>
   */
  "public static function getCamera",function getCamera(name/*:String = null*/)/*:Camera*/ {switch(arguments.length){case 0:name = null;}
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   *
   */
  "public function setLoopback",function setLoopback(compress/*:Boolean = false*/)/*:void*/ {switch(arguments.length){case 0:compress = false;}
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   * </listing>
   */
  "public function setMode",function setMode(width/*:int*/, height/*:int*/, fps/*:Number*/, favorArea/*:Boolean = true*/)/*:void*/ {switch(arguments.length){case 0:case 1:case 2:case 3:favorArea = true;}
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   * </listing>
   */
  "public function setMotionLevel",function setMotionLevel(motionLevel/*:int*/, timeout/*:int = 2000*/)/*:void*/ {switch(arguments.length){case 0:case 1:timeout = 2000;}
    throw new Error('not implemented'); // TODO: implement!
  },
