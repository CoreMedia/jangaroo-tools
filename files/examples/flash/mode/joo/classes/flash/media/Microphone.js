...
"public final class Microphone extends flash.events.EventDispatcher",2,function($$private){;return[ 
   ...
   * </listing>
   */
  "public static function getMicrophone",function getMicrophone(index/*:int = -1*/)/*:Microphone*/ {switch(arguments.length){case 0:index = -1;}
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   *
   */
  "public function setLoopBack",function setLoopBack(state/*:Boolean = true*/)/*:void*/ {switch(arguments.length){case 0:state = true;}
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   *
   */
  "public function setSilenceLevel",function setSilenceLevel(silenceLevel/*:Number*/, timeout/*:int = -1*/)/*:void*/ {switch(arguments.length){case 0:case 1:timeout = -1;}
    throw new Error('not implemented'); // TODO: implement!
  },
