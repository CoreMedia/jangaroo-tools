...
"public final class BlurFilter extends flash.filters.BitmapFilter",2,function($$private){;return[ 
   ...
   *
   */
  "public function BlurFilter",function BlurFilter$(blurX/*:Number = 4.0*/, blurY/*:Number = 4.0*/, quality/*:int = 1*/) {switch(arguments.length){case 0:blurX = 4.0;case 1:blurY = 4.0;case 2:quality = 1;}this.super$2();
    throw new Error('not implemented'); // TODO: implement!
  },
