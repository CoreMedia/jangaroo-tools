...
"public final class Accessibility",1,function($$private){;return[ 
   ...
   *
   */
  "public static function sendEvent",function sendEvent(source/*:DisplayObject*/, childID/*:uint*/, eventType/*:uint*/, nonHTML/*:Boolean = false*/)/*:void*/ {switch(arguments.length){case 0:case 1:case 2:case 3:nonHTML = false;}
