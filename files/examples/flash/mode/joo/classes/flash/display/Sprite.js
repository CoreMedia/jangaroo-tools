...
"public class Sprite extends flash.display.DisplayObjectContainer",5,function($$private){;return[ 
   ...
   * </listing>
   */
  "public function startDrag",function startDrag(lockCenter/*:Boolean = false*/, bounds/*:Rectangle = null*/)/*:void*/ {switch(arguments.length){case 0:lockCenter = false;case 1:bounds = null;}
    throw new Error('not implemented'); // TODO: implement!
  },
