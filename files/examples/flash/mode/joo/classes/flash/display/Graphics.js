...
"public final class Graphics",1,function($$private){var as=joo.as;return[function(){joo.classLoader.init(flash.geom.Matrix,flash.display.CapsStyle,Math,flash.display.GradientType,flash.display.JointStyle);}, 
   ...
   * </listing>
   */
  "public function beginBitmapFill",function beginBitmapFill(bitmap/*:BitmapData*/, matrix/*:Matrix = null*/, repeat/*:Boolean = true*/, smooth/*:Boolean = false*/)/*:void*/ {switch(arguments.length){case 0:case 1:matrix = null;case 2:repeat = true;case 3:smooth = false;}
   ...
   */
  "public function beginFill",function beginFill(color/*:uint*/, alpha/*:Number = 1.0*/)/*:void*/ {switch(arguments.length){case 0:case 1:alpha = 1.0;}
   ...
   * @example <a href="http://www.adobe.com/go/learn_as3_usingexamples_en">How to use this example</a>Please see the <a href="http://help.adobe.com/en_US/FlashPlatform/reference/actionscript/3/flash/display/Graphics.html#includeExamplesSummary">example</a> at the end of this class for an illustration of how to use this method.
   */
  "public function drawRoundRect",function drawRoundRect(x/*:Number*/, y/*:Number*/, width/*:Number*/, height/*:Number*/, ellipseWidth/*:Number*/, ellipseHeight/*:Number = NaN*/)/*:void*/ {switch(arguments.length){case 0:case 1:case 2:case 3:case 4:case 5:ellipseHeight = NaN;}
    this.createSpace$1(x + width, y + height);
   ...
   */
  "public function lineStyle",function lineStyle(thickness/*:Number = NaN*/, color/*:uint = 0*/, alpha/*:Number = 1.0*/, pixelHinting/*:Boolean = false*/, scaleMode/*:String = "normal"*/, caps/*:String = null*/, joints/*:String = null*/, miterLimit/*:Number = 3*/)/*:void*/ {switch(arguments.length){case 0:thickness = NaN;case 1:color = 0;case 2:alpha = 1.0;case 3:pixelHinting = false;case 4:scaleMode = "normal";case 5:caps = null;case 6:joints = null;case 7:miterLimit = 3;}
    if (!isNaN(thickness)) {
  ...
  "internal function updateScale",function updateScale(scaleX/*:Number*/, scaleY/*:Number*/)/*:void*/ {
    this.context$1.setTransform(scaleX, 0, 0, scaleY, 0, 0);
    var oldWidth/*:Number*/ = this.width / this.scaleX$1;
    var oldHeight/*:Number*/ = this.height / this.scaleY$1;
  ...
  "private function createGradientStyle",function createGradientStyle(type/*:String*/, colors/*:Array*/, alphas/*:Array*/, ratios/*:Array*/,
                                       ...
                                       interpolationMethod/*:String = "rgb"*/, focalPointRatio/*:Number = 0*/)/* : CanvasGradient*/ {switch(arguments.length){case 0:case 1:case 2:case 3:case 4:matrix = null;case 5:spreadMethod = "pad";case 6:interpolationMethod = "rgb";case 7:focalPointRatio = 0;}
