...
"public class Loader extends flash.display.DisplayObjectContainer",5,function($$private){;return[ 
   ...
   *
   */
  "public function load",function load(request/*:URLRequest*/, context/*:LoaderContext = null*/)/*:void*/ {switch(arguments.length){case 0:case 1:context = null;}
   ...
   *
   */
  "public function loadBytes",function loadBytes(bytes/*:ByteArray*/, context/*:LoaderContext = null*/)/*:void*/ {switch(arguments.length){case 0:case 1:context = null;}
