...
"public class Matrix",1,function($$private){;return[ 
   ...
   * </listing>
   */
  "public function Matrix",function Matrix$(a/*:Number = 1*/, b/*:Number = 0*/, c/*:Number = 0*/, d/*:Number = 1*/, tx/*:Number = 0*/, ty/*:Number = 0*/) {switch(arguments.length){case 0:a = 1;case 1:b = 0;case 2:c = 0;case 3:d = 1;case 4:tx = 0;case 5:ty = 0;}
    this.a = a;
    this.b = b;
    this.c = c;
    this.d = d;
   ...
   * </listing>
   */
  "public function createBox",function createBox(scaleX/*:Number*/, scaleY/*:Number*/, rotation/*:Number = 0*/, tx/*:Number = 0*/, ty/*:Number = 0*/)/*:void*/ {switch(arguments.length){case 0:case 1:case 2:rotation = 0;case 3:tx = 0;case 4:ty = 0;}
   ...
   * </listing>
   */
  "public function createGradientBox",function createGradientBox(width/*:Number*/, height/*:Number*/, rotation/*:Number = 0*/, tx/*:Number = 0*/, ty/*:Number = 0*/)/*:void*/ {switch(arguments.length){case 0:case 1:case 2:rotation = 0;case 3:tx = 0;case 4:ty = 0;}
