...
"public class NetConnection extends flash.events.EventDispatcher",2,function($$private){;return[ 
   ...
   *
   */
  "public function addHeader",function addHeader(operation/*:String*/, mustUnderstand/*:Boolean = false*/, param/*:Object = null*/)/*:void*/ {switch(arguments.length){case 0:case 1:mustUnderstand = false;case 2:param = null;}
    throw new Error('not implemented'); // TODO: implement!
  },
