...
"public class URLLoader extends flash.events.EventDispatcher",2,function($$private){var is=joo.is,$$bound=joo.boundMethod,trace=joo.trace;return[function(){joo.classLoader.init(flash.events.Event,js.XMLHttpRequest);}, 
   ...
   *
   */
  "public function URLLoader",function URLLoader$(request/*:URLRequest = null*/) {switch(arguments.length){case 0:request = null;}this.super$2();
    if (request) {
      this.load(request);
    }
  },
   ...
   *
   */
  "override public function addEventListener",function addEventListener(type/*:String*/, listener/*:Function*/, useCapture/*:Boolean = false*/, priority/*:int = 0*/, useWeakReference/*:Boolean = false*/)/*:void*/ {switch(arguments.length){case 0:case 1:case 2:useCapture = false;case 3:priority = 0;case 4:useWeakReference = false;}
