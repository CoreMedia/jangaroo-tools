...
"public class FileReference extends flash.events.EventDispatcher",2,function($$private){;return[ 
   ...
   *
   */
  "public function browse",function browse(typeFilter/*:Array = null*/)/*:Boolean*/ {switch(arguments.length){case 0:typeFilter = null;}
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   * </listing>
   */
  "public function download",function download(request/*:URLRequest*/, defaultFileName/*:String = null*/)/*:void*/ {switch(arguments.length){case 0:case 1:defaultFileName = null;}
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   *
   */
  "public function upload",function upload(request/*:URLRequest*/, uploadDataFieldName/*:String = "Filedata"*/, testUpload/*:Boolean = false*/)/*:void*/ {switch(arguments.length){case 0:case 1:uploadDataFieldName = "Filedata";case 2:testUpload = false;}
    throw new Error('not implemented'); // TODO: implement!
  },
