...
"public class SharedObject extends flash.events.EventDispatcher",2,function($$private){;return[ 
   ...
   *
   */
  "public function connect",function connect(myConnection/*:NetConnection*/, params/*:String = null*/)/*:void*/ {switch(arguments.length){case 0:case 1:params = null;}
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   * </listing>
   */
  "public function flush",function flush(minDiskSpace/*:int = 0*/)/*:String*/ {switch(arguments.length){case 0:minDiskSpace = 0;}
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   *
   */
  "public static function getLocal",function getLocal(name/*:String*/, localPath/*:String = null*/, secure/*:Boolean = false*/)/*:SharedObject*/ {switch(arguments.length){case 0:case 1:localPath = null;case 2:secure = false;}
   ...
   *
   */
  "public static function getRemote",function getRemote(name/*:String*/, remotePath/*:String = null*/, persistence/*:Object = false*/, secure/*:Boolean = false*/)/*:SharedObject*/ {switch(arguments.length){case 0:case 1:remotePath = null;case 2:persistence = false;case 3:secure = false;}
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   *
   */
  "public function setProperty",function setProperty(propertyName/*:String*/, value/*:Object = null*/)/*:void*/ {switch(arguments.length){case 0:case 1:value = null;}
    throw new Error('not implemented'); // TODO: implement!
  },
