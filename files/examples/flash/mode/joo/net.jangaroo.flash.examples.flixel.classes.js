...
{switch(arguments.length){case 0:Color=0xff000000;case 1:Duration=1;case 2:FadeComplete=null;case 3:Force=false;}
...
];},[],["org.flixel.FlxSprite","org.flixel.FlxG"], "0.8.0", "0.8.2-SNAPSHOT"
);
...
{switch(arguments.length){case 0:Color=0xffffffff;case 1:Duration=1;case 2:FlashComplete=null;case 3:Force=false;}
if(!Force&&this.exists)return;
this.fill(Color);
this._delay=Duration;
...
];},[],["flash.display.Sprite","flash.display.LoaderInfo","flash.net.URLRequest","flash.display.Loader","flash.events.Event"], "0.8.0", "0.8.2-SNAPSHOT"
);
...
{switch(arguments.length){case 0:Graphic=null;case 1:XOffset=0;case 2:YOffset=0;}
this._out=true;
if(Graphic!=null)
...
{switch(arguments.length){case 0:case 1:XOffset=0;case 2:YOffset=0;}
if(Graphic==null)
...
];},[],["resource:org/flixel/data/cursor.png","org.flixel.FlxSprite","org.flixel.FlxU"], "0.8.0", "0.8.2-SNAPSHOT"
);
...
];},[],["org.flixel.FlxGroup","resource:org/flixel/data/key_minus.png","resource:org/flixel/data/key_plus.png","resource:org/flixel/data/key_0.png","resource:org/flixel/data/key_p.png","org.flixel.FlxG","org.flixel.FlxSprite","org.flixel.FlxText"], "0.8.0", "0.8.2-SNAPSHOT"
);
...
{switch(arguments.length){case 0:Intensity=0.05;case 1:Duration=0.5;}
this.stop();
...
];},[],["org.flixel.FlxG","Math"], "0.8.0", "0.8.2-SNAPSHOT"
);
...
{switch(arguments.length){case 0:case 1:Quantity=50;case 2:BakedRotations=16;case 3:Multiple=true;case 4:Collide=0;case 5:Bounce=0;}
...
{switch(arguments.length){case 0:Min=0;case 1:Max=0;}
...
{switch(arguments.length){case 0:Explode=true;case 1:Delay=0;case 2:Quantity=0;}
...
{switch(arguments.length){case 0:Delay=3;}
this._explode=true;
this.delay=Delay;
if(this.delay<0)
this.delay=-Delay;
...
];},[],["org.flixel.FlxGroup","org.flixel.FlxPoint","Array","org.flixel.FlxSprite","org.flixel.data.FlxParticle","uint","org.flixel.FlxU","org.flixel.FlxG","org.flixel.FlxObject"], "0.8.0", "0.8.2-SNAPSHOT"
);
...
{switch(arguments.length){case 0:case 1:Volume=1.0;}
...
"static public function play",function(EmbeddedSound,Volume,Looped,Skip)
{switch(arguments.length){case 0:case 1:Volume=1.0;case 2:Looped=false;case 3:Skip=0;}
var i=0;
...
{switch(arguments.length){case 0:case 1:Volume=1.0;case 2:Looped=false;}
var i=0;
var sl=org.flixel.FlxG.sounds.length;
while(i<sl)
{
...
{switch(arguments.length){case 0:ForceDestroy=false;}
...
{switch(arguments.length){case 0:case 1:case 2:case 3:Unique=false;case 4:Key=null;}
var key=Key;
if(key==null)
{
...
{switch(arguments.length){case 0:case 1:Reverse=false;case 2:Unique=false;case 3:Key=null;}
...
{switch(arguments.length){case 0:case 1:Lerp=1;}
...
{switch(arguments.length){case 0:LeadX=0;case 1:LeadY=0;}
...
{switch(arguments.length){case 0:MinX=0;case 1:MinY=0;case 2:MaxX=0;case 3:MaxY=0;case 4:UpdateWorldBounds=true;}
...
{switch(arguments.length){case 0:case 1:case 2:case 3:Zoom=2;}this.super$6();
flash.ui.Mouse.hide();
this._zoom=Zoom;
...
{switch(arguments.length){case 0:Silent=false;}
if(!Silent)
...
{switch(arguments.length){case 0:case 1:Default=0;}
this._size=Size;
if(this._size<=0)
this._size=1;
this._itr=0;
...
"public function flicker",function(Duration){switch(arguments.length){case 0:Duration=1;}this._flickerTimer=Duration;if(this._flickerTimer<0){this._flicker=false;this.visible=true;}},
...
];},[],["org.flixel.FlxU"], "0.8.0", "0.8.2-SNAPSHOT"
);
...
{switch(arguments.length){case 0:case 1:case 2:case 3:case 4:Parent=null;}
this.super$3(X,Y,Width,Height);
...
{switch(arguments.length){case 0:BothLists=true;case 1:Callback=null;}
...
{switch(arguments.length){case 0:Iterator=null;}
var c=false;
var co;
var itr=Iterator;
if(itr==null)
...
];},[],["org.flixel.FlxRect","org.flixel.data.FlxList","uint","org.flixel.FlxGroup","org.flixel.FlxObject","org.flixel.FlxU"], "0.8.0", "0.8.2-SNAPSHOT"
);
...
];},[],["org.flixel.FlxPoint"], "0.8.0", "0.8.2-SNAPSHOT"
);
...
{switch(arguments.length){case 0:case 1:case 2:MinFileSize=0;}
if(this._so==null)
{
...
{switch(arguments.length){case 0:MinFileSize=0;}
if(this._so==null)
{
...
];},[],["Object","flash.net.SharedObject","Error","org.flixel.FlxG","flash.net.SharedObjectFlushStatus"], "0.8.0", "0.8.2-SNAPSHOT"
);
...
"public function play",function(Skip)
...
this._channel=this._sound.play(Skip,9999,this._transform);
if(this._channel==null)
this.active=false;
}
else
...
if(this._channel==null)
{
this._channel=this._sound.play(Skip,0,this._transform);
if(this._channel==null)
this.active=false;
else
...
{switch(arguments.length){case 0:case 1:Rotations=16;case 2:Frame=-1;case 3:AntiAliasing=false;case 4:AutoBuffer=false;}
...
this._pixels=org.flixel.FlxG.createBitmap($$uint(this.width),$$uint(this.height),0,true,key);
this._colorTransformedPixels=null;
...
{switch(arguments.length){case 0:case 1:case 2:Color=0xffffffff;case 3:Unique=false;case 4:Key=null;}
this._bakedRotation=0;
...
{switch(arguments.length){case 0:case 1:X=0;case 2:Y=0;}
...
{switch(arguments.length){case 0:case 1:case 2:case 3:case 4:case 5:Thickness=1;}
...
if(ta<0)
ta+=360;
this._caf=$$uint(ta/this._bakedRotation);
if(oc!=this._caf)
this.calcFrame();
return;
}
...
{switch(arguments.length){case 0:case 1:Force=false;}
...
{
this._curAnim=null;
this._caf=$$uint(org.flixel.FlxU.random()*(this._pixels.width/this.frameWidth));
this.calcFrame();
},
...
];},[],["org.flixel.FlxObject","flash.geom.Rectangle","flash.geom.Point","org.flixel.FlxPoint","Array","flash.geom.Matrix","flash.display.Sprite","org.flixel.FlxG","uint","Math","flash.display.BitmapData","org.flixel.FlxU","String","flash.geom.ColorTransform","org.flixel.data.FlxAnim","int"], "0.8.0", "0.8.2-SNAPSHOT"
);
...
];},[],["flash.display.Sprite","org.flixel.FlxGroup","org.flixel.FlxSprite","org.flixel.FlxG","org.flixel.FlxU"], "0.8.0", "0.8.2-SNAPSHOT"
);
...
var ox;
var oy=0;
var widthInTiles=$$uint(this.width/sw);
var heightInTiles=$$uint(this.height/sh);
...
{switch(arguments.length){case 0:case 1:case 2:TileWidth=0;case 3:TileHeight=0;}
this.refresh=true;
var cols;
...
while(c<iw)
{
if($$uint(this._data[rs+c])>=this.collideIndex)
...
{
return $$uint(this._data[Index]);
},
"public function setTile",function(X,Y,Tile,UpdateGraphics)
{switch(arguments.length){case 0:case 1:case 2:case 3:UpdateGraphics=true;}
...
{switch(arguments.length){case 0:case 1:case 2:UpdateGraphics=true;}
...
{switch(arguments.length){case 0:case 1:case 2:case 3:case 4:case 5:Resolution=1;}
...
if($$uint(this._data[ty*this.widthInTiles+tx])>=this.collideIndex)
{
tx*=this._tileWidth;
ty*=this._tileHeight;
var rx=0;
...
{switch(arguments.length){case 0:case 1:Invert=false;case 2:Scale=1;}
if(Scale>1)
{
var bd=bitmapData;
...
];},["arrayToCSV","bitmapToCSV","imageToCSV"],["org.flixel.FlxObject","resource:org/flixel/data/autotiles.png","resource:org/flixel/data/autotiles_alt.png","org.flixel.FlxPoint","flash.geom.Rectangle","Array","uint","org.flixel.FlxG","org.flixel.FlxU","flash.display.BitmapData","Math","String","int","flash.geom.Matrix"], "0.8.0", "0.8.2-SNAPSHOT"
);
...
{switch(arguments.length){case 0:Seed=NaN;}
if(isNaN(Seed))
return Math.random();
else
{
...
{switch(arguments.length){case 0:case 1:Name="Profiler";case 2:Log=true;}
...
{switch(arguments.length){case 0:case 1:case 2:case 3:case 4:case 5:P=null;}
var sin=0;
var cos=0;
...
{switch(arguments.length){case 0:case 1:case 2:case 3:Alpha=1.0;}
...
{switch(arguments.length){case 0:case 1:Results=null;}
if(Results==null)
Results=new Array();
...
{switch(arguments.length){case 0:case 1:Simple=false;}
...
{switch(arguments.length){case 0:case 1:Acceleration=0;case 2:Drag=0;case 3:Max=10000;}
if(Acceleration!=0)
...
{switch(arguments.length){case 0:X=0;case 1:Y=0;case 2:Width=0;case 3:Height=0;case 4:Divisions=3;}
...
{switch(arguments.length){case 0:case 1:case 2:Callback=null;}
