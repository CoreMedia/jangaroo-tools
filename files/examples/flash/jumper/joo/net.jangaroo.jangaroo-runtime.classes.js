...
];},["create"],["Object","Error","RegExp"], "0.8.0", "0.8.2-SNAPSHOT"
);joo.classLoader.prepare(
"package joo",
...
];},["createEmptyConstructor"],["Error"], "0.8.0", "0.8.2-SNAPSHOT"
);joo.classLoader.prepare(
"package joo",
...
];},["isRuntimeCompatible","addToMetadata"],["Error","joo.JooClassDeclaration","joo.NativeClassDeclaration"], "0.8.0", "0.8.2-SNAPSHOT"
);joo.classLoader.prepare("package",
"public dynamic class ArgumentError extends Error",2,function($$private){;return[
"public function ArgumentError",function(message){switch(arguments.length){case 0:message="";}
...
"public function DefinitionError",function(message){switch(arguments.length){case 0:message="";}
this.super$2(message);
},
];},[],["Error"], "0.8.0", "0.8.2-SNAPSHOT"
);joo.classLoader.prepare("package",
"public dynamic class SecurityError extends Error",2,function($$private){;return[
"public function SecurityError",function(message){switch(arguments.length){case 0:message="";}
this.super$2(message);
},
];},[],["Error"], "0.8.0", "0.8.2-SNAPSHOT"
);joo.classLoader.prepare(
...
"public function every",function(callback,thisObject){switch(arguments.length){case 0:case 1:thisObject=null;}
var i=0,
j=this.length;
if(thisObject){
for(;i<j;i++){
...
"public function indexOf",function(searchElement,fromIndex){switch(arguments.length){case 0:case 1:fromIndex=0;}
var len=this.length;
...
"public function lastIndexOf",function(searchElement,fromIndex){switch(arguments.length){case 0:case 1:fromIndex=0x7fffffff;}
var len=this.length;
...
"public function map",function(callback,thisObject){switch(arguments.length){case 0:case 1:thisObject=null;}
var results=[];
var i=0,
j=this.length;
if(thisObject){
...
"public function some",function(callback,thisObject){switch(arguments.length){case 0:case 1:thisObject=null;}
var i=0,
j=this.length;
if(thisObject){
for(;i<j;i++){
...
"private function loadResource",function(path){var this$=this;var this$=this;var this$=this;
...
];},[],["joo.StandardClassLoader","joo.JooClassDeclaration"], "0.8.0", "0.8.2-SNAPSHOT"
);joo.classLoader.prepare(
"package joo",
...
expires,
domain,
secure){switch(arguments.length){case 0:case 1:case 2:path=null;case 3:expires=null;case 4:domain=null;case 5:secure=false;}
var document=joo.getQualifiedObject("document");
document.cookie=
...
];},[],["joo.DynamicClassLoader","joo.localization","joo.JooClassDeclaration","joo.NativeClassDeclaration","Date"], "0.8.0", "0.8.2-SNAPSHOT"
