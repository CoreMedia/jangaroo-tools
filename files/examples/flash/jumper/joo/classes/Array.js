...
"public dynamic class Array",1,function($$private){;return[ 
   ...
   * </listing>
   */
  "public function every",function every(callback/*:Function*/, thisObject/*:* = null*/)/*:Boolean*/ {switch(arguments.length){case 0:case 1:thisObject = null;}
    var i/*:uint*/ = 0,
      j/*:uint*/ = this.length;
   ...
   * </listing>
   */
  "public function indexOf",function indexOf(searchElement/*:**/, fromIndex/*:int = 0*/)/*:int*/ {switch(arguments.length){case 0:case 1:fromIndex = 0;}
    var len/*:uint*/ = this.length;
   ...
   * </listing>
   */
  "public function lastIndexOf",function lastIndexOf(searchElement/*:**/, fromIndex/*:int = 0x7fffffff*/)/*:int*/ {switch(arguments.length){case 0:case 1:fromIndex = 0x7fffffff;}
    // TODO: test!
    var len/*:uint*/ = this.length;
   ...
   * </listing>
   */
  "public function map",function map(callback/*:Function*/, thisObject/*:* = null*/)/*:Array*/ {switch(arguments.length){case 0:case 1:thisObject = null;}
    var results/*:Array*/ = [];
    var i/*:uint*/ = 0,
      j/*:uint*/ = this.length;
    // for maximum performance, repeat for-loop code with different function invocations:
   ...
   * </listing>
   */
  "public function some",function some(callback/*:Function*/, thisObject/*:* = null*/)/*:Boolean*/ {switch(arguments.length){case 0:case 1:thisObject = null;}
    var i/*:uint*/ = 0,
      j/*:uint*/ = this.length;
    // for maximum performance, repeat for-loop code with different function invocations:
    if (thisObject) {
