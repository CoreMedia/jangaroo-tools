joo.classLoader.prepare("package org.flixel",/*
{
	...
	"public class FlxU",1,function($$private){var as=joo.as;return[function(){joo.classLoader.init(Number,Math,org.flixel.FlxG,org.flixel.FlxQuadTree);},
		 ...
		 */
		"static public function openURL",function openURL(URL/*:String*/)/*:void*/
		{
			flash.net.navigateToURL(new flash.net.URLRequest(URL), "_blank");
		},
		
		"static public function abs",function abs(N/*:Number*/)/*:Number*/
		{
			return (N>0)?N:-N;
		},
		
		"static public function floor",function floor(N/*:Number*/)/*:Number*/
		{
			var n/*:Number*/ = $$int(N);
			return (N>0)?(n):((n!=N)?(n-1):(n));
		},
		
		"static public function ceil",function ceil(N/*:Number*/)/*:Number*/
		{
			var n/*:Number*/ = $$int(N);
			return (N>0)?((n!=N)?(n+1):(n)):(n);
		},
		
		"static public function min",function min(N1/*:Number*/,N2/*:Number*/)/*:Number*/
		{
			return (N1 <= N2)?N1:N2;
		},
		
		"static public function max",function max(N1/*:Number*/,N2/*:Number*/)/*:Number*/
		{
			return (N1 >= N2)?N1:N2;
		},
		 ...
		 */
		"static public function random",function random(Seed/*:Number=NaN*/)/*:Number*/
		 ...
		 */
		"static public function startProfile",function startProfile()/*:uint*/
		{
		 ...
		 * @return	A <code>uint</code> to be passed to <code>FlxU.endProfile()</code>.
		 */
		"static public function endProfile",function endProfile(Start/*:uint*/,Name/*:String="Profiler"*/,Log/*:Boolean=true*/)/*:uint*/
		 ...
		 */
		"static public function rotatePoint",function rotatePoint(X/*:Number*/, Y/*:Number*/, PivotX/*:Number*/, PivotY/*:Number*/, Angle/*:Number*/,P/*:FlxPoint=null*/)/*:FlxPoint*/
		 ...
		 */
		"static public function getAngle",function getAngle(X/*:Number*/, Y/*:Number*/)/*:Number*/
		{
		 ...
		 */
		"static public function getColor",function getColor(Red/*:uint*/, Green/*:uint*/, Blue/*:uint*/, Alpha/*:Number=1.0*/)/*:uint*/
		 ...
		 * @return	The color as a <code>uint</code>.
		 */
		"static public function getColorHSB",function getColorHSB(Hue/*:Number*/,Saturation/*:Number*/,Brightness/*:Number*/,Alpha/*:Number=1.0*/)/*:uint*/
		{switch(arguments.length){case 0:case 1:case 2:case 3:Alpha=1.0;}
			var red/*:Number*/;
			var green/*:Number*/;
			var blue/*:Number*/;
		 ...
		 */
		"static public function getRGBA",function getRGBA(Color/*:uint*/,Results/*:Array=null*/)/*:Array*/
		 ...
		 * @return	An <code>Array</code> object containing the Red, Green, Blue and Alpha values of the given color.
		 */
		"static public function getHSB",function getHSB(Color/*:uint*/,Results/*:Array=null*/)/*:Array*/
		{switch(arguments.length){case 0:case 1:Results=null;}
			if(Results == null)
				Results = new Array();
		 ...
		 */
		"static public function getClassName",function getClassName(Obj/*:Object*/,Simple/*:Boolean=false*/)/*:String*/
		{switch(arguments.length){case 0:case 1:Simple=false;}
			var s/*:String*/ = flash.utils.getQualifiedClassName(Obj);
			s = s.replace("::",".");
			if(Simple)
		 ...
		 */
		"static public function getClass",function getClass(Name/*:String*/)/*:Class*/
		{
		 ...
		 */
		"static public function computeVelocity",function computeVelocity(Velocity/*:Number*/, Acceleration/*:Number=0*/, Drag/*:Number=0*/, Max/*:Number=10000*/)/*:Number*/
		{switch(arguments.length){case 0:case 1:Acceleration=0;case 2:Drag=0;case 3:Max=10000;}
			...
			{
				var d/*:Number*/ = Drag*org.flixel.FlxG.elapsed;
				if(Velocity - d > 0)
					Velocity = Velocity - d;
		 ...
		 */
		"static public function setWorldBounds",function setWorldBounds(X/*:Number=0*/, Y/*:Number=0*/, Width/*:Number=0*/, Height/*:Number=0*/, Divisions/*:uint=3*/)/*:void*/
		 ...
		 */
		"static public function overlap",function overlap(Object1/*:FlxObject*/,Object2/*:FlxObject*/,Callback/*:Function=null*/)/*:Boolean*/
		 ...
		 * @param	Object2		The second object or group you want to check.  If it is the same as the first, flixel knows to just do a comparison within that group.
		 */
		"static public function collide",function collide(Object1/*:FlxObject*/,Object2/*:FlxObject*/)/*:Boolean*/
		{
			if( (Object1 == null) || !Object1.exists ||
				(Object2 == null) || !Object2.exists )
				return false;
			...
			if(!match)
				org.flixel.FlxU.quadTree.add(Object2,org.flixel.FlxQuadTree.B_LIST);
			var cx/*:Boolean*/ = org.flixel.FlxU.quadTree.overlap(!match,org.flixel.FlxU.solveXCollision);
			var cy/*:Boolean*/ = org.flixel.FlxU.quadTree.overlap(!match,org.flixel.FlxU.solveYCollision);
			return cx || cy;			
		},
		 ...
		 */
		"static public function solveXCollision",function solveXCollision(Object1/*:FlxObject*/, Object2/*:FlxObject*/)/*:Boolean*/
		{
...
f2&&( (Object2.colVector.x == 0) && (o2 == 0));
		 ...
		 * @param	Object2		The second object or group you want to check.
		 */
		"static public function solveYCollision",function solveYCollision(Object1/*:FlxObject*/, Object2/*:FlxObject*/)/*:Boolean*/
		{
			//Avoid messed up collisions ahead of time
