...
"public class TextField extends flash.display.InteractiveObject",4,function($$private){;return[function(){joo.classLoader.init(flash.text.TextFormatAlign);}, 
   ...
   */
  "public function getTextFormat",function getTextFormat(beginIndex/*:int = -1*/, endIndex/*:int = -1*/)/*:TextFormat*/ {switch(arguments.length){case 0:beginIndex = -1;case 1:endIndex = -1;}
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   * </listing>
   */
  "public function setTextFormat",function setTextFormat(format/*:TextFormat*/, beginIndex/*:int = -1*/, endIndex/*:int = -1*/)/*:void*/ {switch(arguments.length){case 0:case 1:beginIndex = -1;case 2:endIndex = -1;}
