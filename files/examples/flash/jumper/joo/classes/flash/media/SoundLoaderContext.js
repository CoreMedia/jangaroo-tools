...
"public class SoundLoaderContext",1,function($$private){;return[ 
   ...
   * </listing>
   */
  "public function SoundLoaderContext",function SoundLoaderContext$(bufferTime/*:Number = 1000*/, checkPolicyFile/*:Boolean = false*/) {switch(arguments.length){case 0:bufferTime = 1000;case 1:checkPolicyFile = false;}
