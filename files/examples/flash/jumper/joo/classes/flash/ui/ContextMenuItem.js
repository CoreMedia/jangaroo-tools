...
"public final class ContextMenuItem extends flash.events.EventDispatcher",2,function($$private){;return[ 
   ...
   *
   */
  "public function ContextMenuItem",function ContextMenuItem$(caption/*:String*/, separatorBefore/*:Boolean = false*/, enabled/*:Boolean = true*/, visible/*:Boolean = true*/) {switch(arguments.length){case 0:case 1:separatorBefore = false;case 2:enabled = true;case 3:visible = true;}this.super$2();
    throw new Error('not implemented'); // TODO: implement!
  },
