...
"public class DisplayObject extends flash.events.EventDispatcher implements flash.display.IBitmapDrawable",2,function($$private){var $$bound=joo.boundMethod,trace=joo.trace;return[function(){joo.classLoader.init(flash.events.KeyboardEvent,flash.events.MouseEvent);}, 
   ...
   * </listing>
   */
  "public function hitTestPoint",function hitTestPoint(x/*:Number*/, y/*:Number*/, shapeFlag/*:Boolean = false*/)/*:Boolean*/ {switch(arguments.length){case 0:case 1:case 2:shapeFlag = false;}
    throw new Error('not implemented'); // TODO: implement!
  },
  ...
  "override public function addEventListener",function addEventListener(type/* : String*/, listener/* : Function*/, useCapture/* : Boolean = false*/,
                                            priority/* : int = 0*/, useWeakReference/* : Boolean = false*/)/* : void*/ {switch(arguments.length){case 0:case 1:case 2:useCapture = false;case 3:priority = 0;case 4:useWeakReference = false;}
   ...
   * @inheritDoc
   */
  "override public function removeEventListener",function removeEventListener(type/* : String*/, listener/* : Function*/, useCapture/* : Boolean = false*/)/*:void*/ {switch(arguments.length){case 0:case 1:case 2:useCapture = false;}
  ...
  "protected function createElement",function createElement()/* : HTMLElement*/ {
    ...
    elem['onselectstart'] = function flash$display$DisplayObject$1539_29()/*:Boolean*/ {return false;};
    return elem;
  },
