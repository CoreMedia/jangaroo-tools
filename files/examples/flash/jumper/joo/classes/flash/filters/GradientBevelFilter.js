...
"public final class GradientBevelFilter extends flash.filters.BitmapFilter",2,function($$private){;return[ 
   ...
   *
   */
  "public function GradientBevelFilter",function GradientBevelFilter$(distance/*:Number = 4.0*/, angle/*:Number = 45*/, colors/*:Array = null*/, alphas/*:Array = null*/, ratios/*:Array = null*/, blurX/*:Number = 4.0*/, blurY/*:Number = 4.0*/, strength/*:Number = 1*/, quality/*:int = 1*/, type/*:String = "inner"*/, knockout/*:Boolean = false*/) {switch(arguments.length){case 0:distance = 4.0;case 1:angle = 45;case 2:colors = null;case 3:alphas = null;case 4:ratios = null;case 5:blurX = 4.0;case 6:blurY = 4.0;case 7:strength = 1;case 8:quality = 1;case 9:type = "inner";case 10:knockout = false;}this.super$2();
    throw new Error('not implemented'); // TODO: implement!
  },
