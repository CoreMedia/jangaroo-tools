...
"public final class GlowFilter extends flash.filters.BitmapFilter",2,function($$private){;return[ 
   ...
   *
   */
  "public function GlowFilter",function GlowFilter$(color/*:uint = 0xFF0000*/, alpha/*:Number = 1.0*/, blurX/*:Number = 6.0*/, blurY/*:Number = 6.0*/, strength/*:Number = 2*/, quality/*:int = 1*/, inner/*:Boolean = false*/, knockout/*:Boolean = false*/) {switch(arguments.length){case 0:color = 0xFF0000;case 1:alpha = 1.0;case 2:blurX = 6.0;case 3:blurY = 6.0;case 4:strength = 2;case 5:quality = 1;case 6:inner = false;case 7:knockout = false;}this.super$2();
    throw new Error('not implemented'); // TODO: implement!
  },
