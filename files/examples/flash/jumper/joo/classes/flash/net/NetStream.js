...
"public class NetStream extends flash.events.EventDispatcher",2,function($$private){;return[ 
   ...
   * </listing></div>
   */
  "public function NetStream",function NetStream$(connection/*:NetConnection*/, peerID/*:String = "connectToFMS"*/) {switch(arguments.length){case 0:case 1:peerID = "connectToFMS";}this.super$2();
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   *
   */
  "public function attachCamera",function attachCamera(theCamera/*:Camera*/, snapshotMilliseconds/*:int = -1*/)/*:void*/ {switch(arguments.length){case 0:case 1:snapshotMilliseconds = -1;}
    throw new Error('not implemented'); // TODO: implement!
  },
 ...
 * </listing>
 */
"public function publish",function publish(name/*:String = null*/, type/*:String = null*/)/*:void*/ {switch(arguments.length){case 0:name = null;case 1:type = null;}
  throw new Error('not implemented'); // TODO: implement!
},
