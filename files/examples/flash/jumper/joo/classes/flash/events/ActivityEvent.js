...
"public class ActivityEvent extends flash.events.Event",2,function($$private){;return[ 
   ...
   *
   */
  "public function ActivityEvent",function ActivityEvent$(type/*:String*/, bubbles/*:Boolean = false*/, cancelable/*:Boolean = false*/, activating/*:Boolean = false*/) {switch(arguments.length){case 0:case 1:bubbles = false;case 2:cancelable = false;case 3:activating = false;}
