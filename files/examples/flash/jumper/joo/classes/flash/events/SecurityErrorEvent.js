...
"public class SecurityErrorEvent extends flash.events.ErrorEvent",4,function($$private){;return[ 
   ...
   *
   */
  "public function SecurityErrorEvent",function SecurityErrorEvent$(type/*:String*/, bubbles/*:Boolean = false*/, cancelable/*:Boolean = false*/, text/*:String = ""*/, id/*:int = 0*/) {switch(arguments.length){case 0:case 1:bubbles = false;case 2:cancelable = false;case 3:text = "";case 4:id = 0;}
