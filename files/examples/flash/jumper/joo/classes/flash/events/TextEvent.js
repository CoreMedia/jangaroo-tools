...
"public class TextEvent extends flash.events.Event",2,function($$private){;return[ 
   ...
   *
   */
  "public function TextEvent",function TextEvent$(type/*:String*/, bubbles/*:Boolean = false*/, cancelable/*:Boolean = false*/, text/*:String = ""*/) {switch(arguments.length){case 0:case 1:bubbles = false;case 2:cancelable = false;case 3:text = "";}
