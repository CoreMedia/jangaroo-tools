...
"public class ErrorEvent extends flash.events.TextEvent",3,function($$private){;return[ 
   ...
   *
   */
  "public function ErrorEvent",function ErrorEvent$(type/*:String*/, bubbles/*:Boolean = false*/, cancelable/*:Boolean = false*/, text/*:String = ""*/, id/*:int = 0*/) {switch(arguments.length){case 0:case 1:bubbles = false;case 2:cancelable = false;case 3:text = "";case 4:id = 0;}
