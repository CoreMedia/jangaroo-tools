...
"public class StatusEvent extends flash.events.Event",2,function($$private){;return[ 
   ...
   *
   */
  "public function StatusEvent",function StatusEvent$(type/*:String*/, bubbles/*:Boolean = false*/, cancelable/*:Boolean = false*/, code/*:String = ""*/, level/*:String = ""*/) {switch(arguments.length){case 0:case 1:bubbles = false;case 2:cancelable = false;case 3:code = "";case 4:level = "";}
