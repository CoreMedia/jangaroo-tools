...
"public class FullScreenEvent extends flash.events.ActivityEvent",3,function($$private){;return[ 
   ...
   *
   */
  "public function FullScreenEvent",function FullScreenEvent$(type/*:String*/, bubbles/*:Boolean = false*/, cancelable/*:Boolean = false*/, fullScreen/*:Boolean = false*/) {switch(arguments.length){case 0:case 1:bubbles = false;case 2:cancelable = false;case 3:fullScreen = false;}
