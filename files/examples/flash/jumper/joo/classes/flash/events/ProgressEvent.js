...
"public class ProgressEvent extends flash.events.Event",2,function($$private){;return[ 
   ...
   *
   */
  "public function ProgressEvent",function ProgressEvent$(type/*:String*/, bubbles/*:Boolean = false*/, cancelable/*:Boolean = false*/, bytesLoaded/*:Number = 0*/, bytesTotal/*:Number = 0*/) {switch(arguments.length){case 0:case 1:bubbles = false;case 2:cancelable = false;case 3:bytesLoaded = 0;case 4:bytesTotal = 0;}
