...
"public class SyncEvent extends flash.events.Event",2,function($$private){;return[ 
   ...
   *
   */
  "public function SyncEvent",function SyncEvent$(type/*:String*/, bubbles/*:Boolean = false*/, cancelable/*:Boolean = false*/, changeList/*:Array = null*/) {switch(arguments.length){case 0:case 1:bubbles = false;case 2:cancelable = false;case 3:changeList = null;}
