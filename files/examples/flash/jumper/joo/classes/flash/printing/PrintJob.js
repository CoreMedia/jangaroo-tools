...
"public class PrintJob extends flash.events.EventDispatcher",2,function($$private){;return[ 
   ...
   *
   */
  "public function addPage",function addPage(sprite/*:Sprite*/, printArea/*:Rectangle = null*/, options/*:PrintJobOptions = null*/, frameNum/*:int = 0*/)/*:void*/ {switch(arguments.length){case 0:case 1:printArea = null;case 2:options = null;case 3:frameNum = 0;}
    throw new Error('not implemented'); // TODO: implement!
  },
