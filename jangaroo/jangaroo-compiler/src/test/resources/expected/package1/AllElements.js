...
public class AllElements extends Panel{
    ...
    var myVar3_50_5_$1/*:button*/ = AS3.cast(AS3.ext.config.button,{});
    ...
    var panel_59_3_$1/*:panel*/ = AS3.cast(AS3.ext.config.panel,{});
    panel_59_3_$1.title = "I am a panel";
    panel_59_3_$1.layout = config.myLayout;
    var someMixin_62_7_$1/*:someMixin*/ = AS3.cast(AS3.ext.config.someMixin,{});
    var button_64_11_$1/*:button*/ = AS3.cast(AS3.ext.config.button,{});
    button_64_11_$1.text = "click me!";
    button_64_11_$1["id"] = "myId";
    var ext_Action_66_15_$1/*:Action*/ = AS3.cast(ext.Action,{});
    ...
    var button_89_7_$1/*:button*/ = AS3.cast(AS3.ext.config.button,{});
    ...
    var menuitem_106_7_$1/*:menuitem*/ = AS3.cast(AS3.ext.config.menuitem,{});
    menuitem_106_7_$1.text = "juhu1";
    var menuitem_107_7_$1/*:menuitem*/ = AS3.cast(AS3.ext.config.menuitem,{});
    menuitem_107_7_$1.text = "juhu2";
    var menuitem_108_7_$1/*:menuitem*/ = AS3.cast(AS3.ext.config.menuitem,{});
    ...
    var aplugin_124_7_$1/*:aplugin*/ = AS3.cast(AS3.ext.config.aplugin,{});
    var aplugin_125_7_$1/*:aplugin*/ = AS3.cast(AS3.ext.config.aplugin,{});
