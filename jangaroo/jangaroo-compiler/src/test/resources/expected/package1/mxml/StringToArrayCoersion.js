...
import ext.*;
public class StringToArrayCoersion extends Panel{public*/function StringToArrayCoersion$(config/*:StringToArrayCoersion=null*/){ext.Panel.prototype.constructor.apply(this,arguments);if(arguments.length<=0)config=null;
