...
public class SimpleMxmlClass extends ConfigClass implements package1.Interface{
    ...
    var configClass_40_7_$1/*:ConfigClass*/ = AS3.cast(AS3.package1.ConfigClass,{});
    var other$ns_SomeOtherClass_41_9_$1/*:SomeOtherClass*/ = AS3.cast(AS3.package1.someOtherPackage.SomeOtherClass,{});
    ...
    var other_45_5_$1/*:SomeOtherClass*/ = AS3.cast(AS3.package1.someOtherPackage.SomeOtherClass,{});
    ...
    var other$ns_SomeOtherClass_50_5_$1/*:SomeOtherClass*/ = AS3.cast(AS3.package1.someOtherPackage.SomeOtherClass,{});
    ...
    var other$ns_SomeOtherClass_54_5_$1/*:SomeOtherClass*/ = AS3.cast(AS3.package1.someOtherPackage.SomeOtherClass,{});
    AS3.setBindable(other$ns_SomeOtherClass_54_5_$1,"bla" , 23);
    var other$ns_SomeOtherClass_55_5_$1/*:SomeOtherClass*/ = AS3.cast(AS3.package1.someOtherPackage.SomeOtherClass,{});
    ...
    var other$ns_SomeOtherClass_56_5_$1/*:SomeOtherClass*/ = AS3.cast(AS3.package1.someOtherPackage.SomeOtherClass,{});
    AS3.setBindable(other$ns_SomeOtherClass_56_5_$1,"bla" , 42);
    other$ns_SomeOtherClass_56_5_$1.number = 24;
    var configClass_61_5_$1/*:ConfigClass*/ = AS3.cast(AS3.package1.ConfigClass,{});
    var other$ns_SomeOtherClass_63_9_$1/*:SomeOtherClass*/ = AS3.cast(AS3.package1.someOtherPackage.SomeOtherClass,{});
    ...
    var configClass_67_5_$1/*:ConfigClass*/ = AS3.cast(AS3.package1.ConfigClass,{});
    var other$ns_SomeOtherClass_69_9_$1/*:SomeOtherClass*/ = AS3.cast(AS3.package1.someOtherPackage.SomeOtherClass,{});
    AS3.setBindable(other$ns_SomeOtherClass_69_9_$1,"bla" , 12);
    var no_config_70_9_$1/*:SomeOtherClass*/ = AS3.cast(AS3.package1.someOtherPackage.SomeOtherClass,{});
    ...
    configClass_67_5_$1.items$at = AS3.net.jangaroo.ext.Exml.APPEND;
    config_$1.items = [new AS3.package1.someOtherPackage.SomeOtherClass(other$ns_SomeOtherClass_54_5_$1), new AS3.package1.someOtherPackage.SomeOtherClass(other$ns_SomeOtherClass_55_5_$1), new AS3.package1.someOtherPackage.SomeOtherClass(other$ns_SomeOtherClass_56_5_$1), new AS3.package1.ConfigClass(configClass_61_5_$1), new AS3.package1.ConfigClass(configClass_67_5_$1)];
