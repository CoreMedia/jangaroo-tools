...
Ext.define("package1.mxml.SimpleMxmlClass", function(SimpleMxmlClass) {/*public class SimpleMxmlClass extends ConfigClass{
  ...
  items:([
    ...
    listeners:{ clickclack: net.jangaroo.ext.Exml.eventHandler( package1.someOtherPackage.ConfigClass_stranger_antonEvent.CLICK_CLACK,package1.someOtherPackage.ConfigClass_stranger_antonEvent,AS3.bind(this,"$on_clickclack_56_43$5_bR"))}}),
    ...
    listeners:{
             click: net.jangaroo.ext.Exml.eventHandler( package1.someOtherPackage.ConfigClass_stranger_antonEvent.CLICK,package1.someOtherPackage.ConfigClass_stranger_antonEvent,AS3.bind(this,"$on_click_14_22$5_bR"))}
}),config));
  }/*
    ...
    private*/ function $on_click_14_22 (event/*:package1.someOtherPackage.ConfigClass_stranger_antonEvent*/)/* :void*/ {
      var result/*:String*/ = 'gotcha: ' + event.source + ' / ' + event.stranger;
    }/*

    private*/ function $on_clickclack_56_43 (event/*:package1.someOtherPackage.ConfigClass_stranger_antonEvent*/)/* :void*/ {
