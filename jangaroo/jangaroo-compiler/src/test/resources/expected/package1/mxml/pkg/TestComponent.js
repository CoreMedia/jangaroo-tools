...
config= AS3.net.jangaroo.ext.Exml.apply(defaults_$1,config);
    ...
    config_$1.letters = [              'a',              'b',              'c'             ]; AS3.net.jangaroo.ext.Exml.apply(config_$1,config);AS3.package1.mxml.pkg.TestComponentBase.prototype.constructor.call(this,config_$1,config);}/*
