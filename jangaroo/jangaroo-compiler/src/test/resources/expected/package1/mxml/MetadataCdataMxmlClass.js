...
function MetadataCdataMxmlClass$(config/*:MetadataCdataMxmlClass=null*/){AS3.package1.ConfigClass.prototype.constructor.call(this);if(arguments.length<=0)config=null;
