...
public class CyclicDependencies extends Object{
    ...
    var config_$1/*:package1.mxml.pkg.CyclicDependencies_1*/ =AS3.cast( AS3.package1.mxml.pkg.CyclicDependencies_1,{});AS3.setBindable(
    this,"cause_trouble" , new AS3.package1.mxml.pkg.CyclicDependencies_1(config_$1));}/*
