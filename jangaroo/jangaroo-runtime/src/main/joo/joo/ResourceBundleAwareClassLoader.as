 ...
 */
public class ResourceBundleAwareClassLoader {
   ...
   * @see #ResourceBundleAwareClassLoader
   */
  public static var INSTANCE:ResourceBundleAwareClassLoader = new ResourceBundleAwareClassLoader();
  ...
  public function createSingleton(resourceBundle:Class):Object {
    var fullLocalizedClassName:String = getLocalizedResourceClassName(resourceBundle);
  ...
  private function getLocalizedResourceClassName(cd:Class):String {
    var localizedResourceClassName:String = cd["$className"];
