...
class Scope {
  ...
  public void declareIde(IdeDeclaration decl) {
    ...
    if (alreadyDeclared != null)
      Jscc.error(decl.ide.ide, "duplicate declaration of identifier '" + name + "'");
    ides.put(name, decl);
  }
  ...
  public void defineLabel(LabeledStatement labeledStatement) {
    ...
    if (s != null)
      Jscc.error(labeledStatement.ide.ide, "label already defined in scope: '" + labeledStatement.ide.getName() + "'");
  ...
  public LabeledStatement lookupLabel(Ide ide) {
    ...
    Jscc.error(ide.ide, "undeclared label '" + name + "'");
  ...
  public IdeDeclaration lookupIde(Ide ide) {
    ...
    if (parent == null)
      Jscc.error(ide.ide, "undeclared identifier: '" + ide.getName() + "'");
