...
REM  ======================================================================
REM
REM $Id: build.bat,v 1.2 2002/02/28 04:43:17 user57 Exp $
REM
REM Authors:
...
set JIDL_EXECUTABLE=win32/jidl.exe

set ANT_OPTS=-Djava.protocol.handler.pkgs=org.jboss.net.protocol -Djavax.xml.parsers.DocumentBuilderFactory=%JAXP_DOM_FACTORY% -Djavax.xml.parsers.SAXParserFactory=%JAXP_SAX_FACTORY% -Dbuild.script=build.bat -Djidl.executable=%JIDL_EXECUTABLE%
