...
# $Id: build.sh,v 1.2 2002/02/28 04:43:17 user57 Exp $
...
# ### should evaluate uname
JIDL_EXECUTABLE=linux-i386/jidl
...
main() {
    ...
    ANT_OPTS="$ANT_OPTS -Djidl.executable=$JIDL_EXECUTABLE"
